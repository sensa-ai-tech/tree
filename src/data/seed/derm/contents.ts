...
| 人醫工具/概念 | 獸醫應用潛力 | 現況 |
|-------------|-------------|------|
| 皮膚鏡（dermoscopy）用於色素病灶評估 | 犬貓毛髮疾病與色素異常的無創評估 | 獸醫皮膚鏡（trichoscopy）逐漸普及 |
| 經表皮水分流失（TEWL）測量 | 量化犬 AD 皮膚屏障功能缺損程度 | 研究使用，臨床尚未常規化 |
| 光動力療法（PDT） | 犬淺表腫瘤/角化異常的非手術治療 | 人醫成熟，獸醫病例報告增加 |
| 生物製劑（biologics） | 犬自體免疫皮膚病的精準治療 | 獸醫可用生物製劑仍有限 |
...
| 人醫工具/概念 | 獸醫應用潛力 | 現況 |
|-------------|-------------|------|
| Rituximab（抗 CD20 單抗）用於頑固性天疱瘡 | 犬自體免疫皮膚病的 B 細胞靶向治療 | 人醫已為天疱瘡二線治療，獸醫無商業化犬用產品 |
