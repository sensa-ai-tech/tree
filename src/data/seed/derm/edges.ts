...
export const DERM_EDGES: KnowledgeEdge[] = [
  ...
  { id: 'DERM-E-076', source_node_id: 'DERM-L1-002', target_node_id: 'DERM-L3-001', relation_type: 'prerequisite', weight: 1, description: '皮膚免疫學（IgE/肥大細胞/Th2 pathway）是理解 CAD 發病機轉的前置知識', bidirectional: false, unlock_condition: null },

  // DERM-L3-002 (食物不良反應)：需理解過敏反應機轉（Type I & Type IV）
  { id: 'DERM-E-077', source_node_id: 'DERM-L2-001', target_node_id: 'DERM-L3-002', relation_type: 'prerequisite', weight: 1, description: '過敏反應機轉（IgE 介導與非 IgE 介導）是理解食物不良反應的基礎', bidirectional: false, unlock_condition: null },

  // DERM-L3-003 (跳蚤過敏性皮膚炎 FAD)：Type I 過敏性超敏反應
  { id: 'DERM-E-078', source_node_id: 'DERM-L2-001', target_node_id: 'DERM-L3-003', relation_type: 'prerequisite', weight: 1, description: '過敏反應機轉（跳蚤唾液蛋白引發的 Type I 超敏反應）是 FAD 的核心病理基礎', bidirectional: false, unlock_condition: null },

  // DERM-L3-006 (馬拉色菌皮膚炎)：需理解角化異常與皮膚屏障
  { id: 'DERM-E-079', source_node_id: 'DERM-L2-002', target_node_id: 'DERM-L3-006', relation_type: 'prerequisite', weight: 1, description: '角化異常導致皮脂過度分泌，為馬拉色菌過度增殖的前提條件', bidirectional: false, unlock_condition: null },

  // DERM-L3-010 (天疱瘡)：自體免疫機轉攻擊橋粒蛋白
  { id: 'DERM-E-080', source_node_id: 'DERM-L2-003', target_node_id: 'DERM-L3-010', relation_type: 'prerequisite', weight: 1, description: '自體免疫皮膚病機轉（抗橋粒蛋白抗體導致棘層鬆解）是天疱瘡的核心前置知識', bidirectional: false, unlock_condition: null },
