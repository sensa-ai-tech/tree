...
### 常見併發症
- **心室心律不整（VPCs）**：術後 12-72 小時最常見，發生率 40-70%，與缺血再灌流損傷相關
- **DIC（瀰漫性血管內凝血）**：內毒素血症與組織壞死觸發凝血級聯，死亡率高
- **胃壁壞死**：術中未發現的早期壞死區可能在術後 24-48 小時穿孔
- **再灌流損傷**：derotation 後 ROS 大量釋放導致全身性發炎反應
- **急性腎損傷**：術中長時間低灌流導致腎小管壞死
...
- **術前 lactate < 6.0 mmol/L**：預後良好 — 存活率 > 90%，胃壁壞死機率低
- **術前 lactate > 6.0 mmol/L**：預後謹慎 — 胃壁壞死風險顯著升高，需 partial gastrectomy 的機率增加
- **需 partial gastrectomy 的病例**：預後保守 — 死亡率 28-38%
- **需 splenectomy 但胃壁完整**：預後中等偏佳 — 存活率仍 > 80%
- **術後併發 DIC 或多器官衰竭**：預後差 — 死亡率 > 50%
- **預後良好因子**：早期就診（< 4 小時）、lactate 快速下降、術後 12 小時內心律正常化、gastropexy 完成
- **預後不良因子**：就診延遲 > 6 小時、lactate > 9 mmol/L、廣泛胃壁壞死、術後持續 VPCs（R-on-T）、DIC

## 六、人醫借鑒 (Translational Insights)

| 人醫工具/概念 | 獸醫應用潛力 | 現況 |
|-------------|-------------|------|
| 腹腔鏡預防性 gastropexy | 高風險品種犬腹腔鏡胃固定術取代傳統開腹預防性 gastropexy | 多中心已常規執行腹腔鏡 gastropexy，術後疼痛與住院天數顯著降低 |
...
### 常見併發症
- **敗血症 / SIRS**：E. coli 內毒素引發全身性發炎反應，封閉型風險更高
- **急性腎損傷（AKI）**：E. coli 內毒素干擾腎小管 ADH 受體，可導致腎性尿崩與腎損傷
- **DIC**：嚴重毒血症觸發凝血級聯，術中或術後出血不止
- **子宮破裂 / 腹膜炎**：封閉型子宮極度擴張時術中操作不慎可致破裂
- **子宮殘端感染**：術後殘端組織感染（stump pyometra），罕見但需注意
...
- **開放型、穩定病例行 OHE**：預後良好 — 手術成功率 > 95%，48-72 小時內明顯改善
- **封閉型、中度毒血症**：預後中等偏佳 — 充分術前穩定化後手術存活率 > 90%
- **併發 DIC 或 AKI 的病例**：預後謹慎 — 死亡率 4-20%
- **子宮破裂合併腹膜炎**：預後差 — 死亡率最高，需積極腹腔灌洗
- **內科治療（開放型）**：預後中等 — 成功率 75-90%，但復發率 20-25%
- **預後良好因子**：早期診斷、開放型、WBC 升高（代表骨髓儲備尚可）、腎功能正常、年齡 < 8 歲
- **預後不良因子**：封閉型、degenerative left shift（WBC 低但 band 比例高）、BUN/Cre 顯著升高、低白蛋白、低血壓
...
### 常見併發症
- **術後出血**：脾門血管結紮不完全或 DIC 導致腹腔再出血
- **心律不整**：HSA 常合併心室心律不整，與腫瘤分泌物質及低灌流相關
- **DIC**：HSA 常見併發症，腫瘤內皮細胞活化凝血系統
- **右心房轉移**：HSA 約 25% 同時侵犯右心房，可導致心包填塞
...
- **良性脾臟腫塊（血腫、結節性增生）**：預後良好 — 脾切後長期存活，無需進一步治療
- **HSA 僅脾臟切除**：預後差 — 中位存活 1-3 個月
- **HSA 脾切 + doxorubicin 化療**：預後保守 — 中位存活 5-7 個月
- **HSA 合併右心房腫塊或 DIC**：預後極差 — 中位存活數週
- **脾臟 I 期 HSA（未破裂、無轉移）**：預後相對較佳 — 中位存活 6-9 個月
- **預後良好因子**：病理為良性、術前 PCV 穩定、無 DIC 徵象、無遠端轉移
- **預後不良因子**：HSA 確診、腹腔破裂出血、右心房侵犯、DIC、肝臟或肺轉移
...
| 偶然發現的小型脾臟腫塊（< 1 cm）是否需手術 | 追蹤觀察 vs 預防性脾臟切除，缺乏明確指引 | Level IV |`,
  ...
  disease_data: {
    ...
    treatment_protocol: '手術：脾臟切除術為首選。術前穩定化包括晶體液復甦與必要時輸血（pRBC 或全血）。術中仔細結紮脾門血管，探查腹腔有無轉移。術後依病理結果：良性——無需進一步治療；HSA——建議 [藥物:Doxorubicin] 為基礎的化療方案（30 mg/m²（體重 < 10 kg 犬改用 1 mg/kg） IV q3w，共 5-6 次）。Primary care：穩定化、輸血、轉診。Specialty care：脾臟切除術 + 腹腔探查 + 依病理決定化療方案。',
...
### 常見併發症
- **腸吻合口洩漏（dehiscence）**：最嚴重的術後併發症，發生率 6-16%，好發術後 3-5 天
- **腹膜炎**：洩漏或術前穿孔導致，表現為發熱、腹痛加劇、WBC 升高
- **短腸症候群**：大範圍腸切除（> 70-80%）後吸收不良，需長期營養支持
- **腸狹窄（stricture）**：吻合處瘢痕狹窄，可於術後數週至數月出現部分阻塞症狀
- **切口感染 / 腹壁疝氣**：術中腹腔汙染增加 SSI 風險
...
- **及時手術、腸道活性良好（僅 enterotomy）**：預後良好 — 存活率 > 90%
- **需腸切除吻合但無穿孔**：預後佳 — 存活率 80-85%
- **合併腹膜炎**：預後謹慎 — 存活率降至 50-74%
- **線狀異物合併多處穿孔**：預後保守 — 手術複雜度高，死亡率上升
- **延遲就醫（> 48-72 小時）**：預後較差 — 腸壁壞死與穿孔風險顯著增加
- **預後良好因子**：早期就醫、單一部位阻塞、腸壁活性佳、無腹膜炎、年輕動物
- **預後不良因子**：線狀異物多處穿孔、廣泛腸壞死需大範圍切除、低白蛋白、敗血性腹膜炎
...
### 常見併發症
- **半月板損傷（術後晚期）**：約 3-6% 病例在 TPLO 術後發生晚期半月板損傷，表現為突發跛行加劇
- **植入物感染 / TPLO plate 感染**：發生率 3-8%，可能需移除植入物
- **脛骨骨折**：TPLO 截骨線處骨折，罕見但可能發生（< 3%），常與術後過早活動相關
- **骨關節炎持續進展**：即使手術成功，OA 仍會緩慢進展
- **對側 CCLD**：40-60% 病例於 1-2 年內對側發生
...
- **TPLO 術後（中大型犬）**：預後良好 — 功能恢復良好至優良 > 90%，大部分犬可恢復正常活動
- **ECLS 術後（小型犬 < 15 kg）**：預後良好 — 成功率 85-90%
- **保守治療（小型犬 < 10 kg）**：預後中等偏佳 — 約 85% 可達臨床可接受功能
- **合併嚴重半月板損傷未處理**：預後保守 — 持續跛行與加速 OA
- **肥胖犬未減重**：預後較差 — 關節負載持續過重，OA 進展加速
- **預後良好因子**：早期手術、術前體重理想、半月板完整或已處理、術後配合復健與限制活動
- **預後不良因子**：肥胖未矯正、對側 CCLD 已存在、嚴重既有 OA、未執行術後復健

## 六、人醫借鑒 (Translational Insights)

| 人醫工具/概念 | 獸醫應用潛力 | 現況 |
|-------------|-------------|------|
| 人醫 ACL 重建術（hamstring / patellar tendon graft） | 犬 CCLD 的關節內韌帶重建——恢復解剖學穩定而非生物力學替代 | 犬關節內重建因移植物退化而成功率低，目前生物力學矯正術（TPLO/TTA）仍為主流 |
...
| 爭議議題 | 現況 | Evidence Level |
|---------|------|---------------|
| TPLO vs TTA 的長期臨床結果比較 | 兩者均為 Level I 證據支持，大型前瞻性 RCT 顯示功能恢復無顯著差異，術者經驗可能更重要 | Level I |
...
### 常見併發症
- **進行性脊髓軟化症（progressive myelomalacia, PMM）**：最致命的併發症，脊髓壞死從病灶向兩端擴展，無法治療，死亡率 100%
- **術後神經功能惡化**：手術操作中的脊髓再損傷，罕見但可能
- **尿路感染（UTI）**：神經性膀胱長期導尿或擠尿導致反覆 UTI
- **褥瘡（decubital ulcers）**：癱瘓犬長期臥床壓迫形成
- **復發**：保守治療復發率約 30-40%，其他椎間盤也可能突出
...
- **Grade 1-2 保守治療**：預後良好 — 85-90% 臨床改善，但復發率 30-40%
- **Grade 1-4 手術治療（DPP 陽性）**：預後良好 — 恢復行走率 > 90%
- **Grade 5 DPP 喪失 < 24-48 小時手術**：預後謹慎 — 恢復率約 50-60%
- **Grade 5 DPP 喪失 > 48 小時**：預後極差 — 恢復率 < 5%
- **進行性脊髓軟化症（PMM）**：預後絕望 — 無法治療，100% 致死
- **預後良好因子**：DPP 保留、早期手術（Grade 5 越早越好）、年輕、體重適中
- **預後不良因子**：DPP 喪失且時間不明、肥胖、多節段椎間盤突出、MRI 顯示脊髓高訊號（T2WI）範圍 > 病灶長度 2 倍
...
### 常見併發症
- **傷口感染**：會陰區靠近肛門，汙染風險高，SSI 發生率 8-26%
- **暫時性大便失禁**：術中肛門括約肌或 pudendal nerve 受牽拉，發生率 10-20%，多為暫時性
- **直腸脫垂**：術後努責排便可導致直腸脫出，發生率 5-8%
- **復發**：手術 + 去勢復發率 10-15%，未去勢 40-50%
- **坐骨神經損傷**：術中辨識不慎可導致永久性後肢跛行（罕見但嚴重）
...
- **手術修補 + 去勢**：預後良好 — 成功率 85-90%，復發率 10-15%
- **手術修補未去勢**：預後保守 — 復發率高達 40-50%
- **膀胱後翻合併嚴重高血鉀 / 氮血症**：預後謹慎 — 術前穩定化至關重要
- **雙側同時修補**：預後中等 — 技術可行但術後腫脹與疼痛較大
- **預後良好因子**：同時去勢、單側且組織缺損不嚴重、閉孔內肌翻轉術、早期治療
- **預後不良因子**：未去勢、雙側嚴重缺損需 mesh、膀胱後翻合併代謝紊亂、坐骨神經損傷
...
### 常見併發症
- **植入物失敗**：螺絲鬆脫、骨板彎曲或斷裂，發生率 2-8%，常因固定不足或過早活動
- **骨不癒合（nonunion）**：發生率 3-5%，最常見原因為不穩定固定與血供不足
- **骨髓炎（osteomyelitis）**：開放性骨折感染率 10-30%（Grade III），需長期抗生素
- **釘道感染（ESF）**：ESF 釘道感染率 10-30%，需每日清潔護理
- **生長板損傷後畸形**：幼犬生長板骨折可致肢體短縮或角度畸形
...
- **閉合性簡單骨折、適當固定**：預後良好 — 癒合率 > 95%
- **開放性 Grade I-II**：預後良好至中等 — 及時處理癒合率 > 85%
- **開放性 Grade III**：預後謹慎 — 感染率高，癒合延遲或不癒合風險增加
- **幼犬骨折**：預後良好 — 癒合快（2-4 週），但需注意生長板影響
- **小型犬橈尺骨遠端骨折**：預後中等 — 不癒合率可達 20%，需鎖定骨板
- **預後良好因子**：年齡幼小、閉合性、簡單骨折型態、良好軟組織覆蓋、適當固定、限制活動配合度佳
- **預後不良因子**：開放性 Grade III、粉碎骨折、小型犬遠端橈骨、感染、延遲就醫、飼主配合度差
...
### 常見併發症
- **復發脫位**：復發率約 5-10%，通常因脛骨粗隆移位不足或滑車溝加深不夠
- **K-wire 移位 / 刺激**：脛骨粗隆固定鋼絲可能遷移或刺激軟組織
- **骨關節炎持續進展**：即使手術矯正，已有的 OA 仍會緩慢進展
- **合併 CCLD 未發現**：15-20% 的 Grade III-IV 合併前十字韌帶斷裂
- **脛骨粗隆骨折**：截骨固定處骨折，罕見，多因 K-wire 尺寸不當
...
- **Grade I-III 手術矯正**：預後良好 — 成功率約 90-95%，功能恢復佳
- **Grade IV 嚴重骨骼畸形**：預後中等 — 成功率 80-85%，可能需分階段手術或矯正截骨
- **Grade I 保守觀察**：預後良好 — 通常不影響生活品質，定期追蹤即可
- **保守治療的 Grade II-III**：預後保守 — 長期 OA 進展較快
- **未矯正的 Grade III-IV**：預後較差 — 繼發前十字韌帶斷裂風險高
- **預後良好因子**：Grade 低（I-II）、體重適中、完整手術組合（trochleoplasty + TTT + imbrication）、雙側評估並處理
- **預後不良因子**：Grade IV 嚴重畸形、肥胖、合併 CCLD 未處理、未做脛骨粗隆移位（僅做滑車溝加深）
...
- **術前系統性評估**：ASA 分級結合血液學與影像檢查，可有效預測手術死亡率——ASA IV-V 犬貓麻醉死亡率可達 5-10%，術前穩定化處置可顯著降低風險
- **急診分流決策**：掌握外科急診優先順序（GDV > 脾臟出血 > 子宮蓄膿 > 腸穿孔）是急診獸醫師的核心能力，延誤 GDV 手術超過 4-6 小時胃壁壞死率急遽上升
- **Halsted 原則的實踐價值**：溫和組織操作與嚴格止血是降低術後併發症（SSI、傷口裂開、血腫）的基石，尤其在台灣常見的老年犬腫瘤手術中格外重要
- **軟組織與骨科的整合思維**：臨床病例常合併多系統問題（如車禍傷犬同時有骨折與腹腔出血），需具備跨領域優先排序能力——先處理危及生命的腹腔出血，再進行骨折固定
- **術後照護品質決定最終預後**：疼痛管理（multimodal analgesia）、早期腸道營養與活動限制的完整執行，可將術後併發症率降低 30-50%
...
- **感染控制的經濟效益**：嚴格無菌技術可將清潔手術 SSI 率從 10% 以上降至 3-5%，每預防一例 SSI 可節省數千至數萬元的後續治療費用（抗生素、二次手術、住院延長）
- **縫線選擇直接影響手術結果**：腹壁閉合使用 PDS（單絲、180 天吸收）可降低腹壁疝氣發生率；感染或汙染手術應避免編織縫線（如 Vicryl），因 wicking effect 會沿纖維間隙傳播細菌
- **電燒使用的組織損傷考量**：單極電燒雖方便但造成的側向熱損傷可達 2-3 mm，靠近腸管、輸尿管或神經時應改用雙極電燒或結紮以避免延遲性穿孔或神經損傷
- **抗生素預防時機的嚴格性**：Cefazolin 必須在切皮前 30 分鐘給予以確保組織濃度達到有效殺菌濃度，研究顯示給藥時機不當（過早或過晚）會使 SSI 風險增加 2-3 倍
- **品種特殊考量**：短鼻犬種（法鬥、巴哥）因皮膚皺褶區域濕度高且通氣不良，術後 SSI 風險較一般品種高；貓的組織對縫線反應較犬敏感，建議優先選用單絲可吸收縫線
...
- **手術時機判斷**：了解傷口癒合的四個階段可幫助臨床醫師決定閉合策略——清潔傷口 6-8 小時內可一期閉合，汙染傷口應開放處理至肉芽組織健康後再行延遲一期閉合（delayed primary closure, 3-5 天）
- **併發症風險預判**：術前白蛋白 < 2.0 g/dL 的犬貓傷口裂開率增加 3-5 倍，長期使用類固醇的動物（如免疫媒介性疾病）抑制發炎期與增殖期，應延長拆線時間（14-21 天 vs 正常 10-14 天）
- **敷料選擇的科學依據**：濕潤環境傷口癒合速度較乾燥環境快 40-50%，高滲出傷口選用 alginate/foam 敷料，低滲出傷口選用 hydrogel/film 敷料，避免使用乾紗布直接接觸傷口床
- **貓的種屬差異**：貓的皮膚較犬薄且血供模式不同（direct cutaneous arteries），皮瓣存活率較犬低，大面積缺損需謹慎評估皮瓣設計；貓的肉芽組織增生能力較犬弱，二期癒合所需時間更長
- **慢性傷口的全身性評估**：傷口持續不癒合（> 2-3 週）應進行全身性排查——甲狀腺功能低下（犬）、糖尿病、腎上腺皮質功能亢進（Cushing's）、隱匿性感染或異物殘留
...
- **術前營養狀態決定手術風險等級**：白蛋白 < 2.0 g/dL 的犬貓傷口裂開率與吻合口洩漏率顯著增加，非緊急手術應先進行 3-5 天營養矯正再手術——每延遲一天矯正營養不良，術後併發症風險可降低 10-15%
- **貓的肝脂肪沉積風險**：貓禁食超過 48-72 小時即有 hepatic lipidosis 風險，尤其肥胖貓（BCS ≥ 7/9），任何原因導致貓食慾廢絕超過 2 天應積極放置 E-tube（食道瘻管），這是貓中長期營養支持的最佳選擇
- **Early enteral nutrition 改善預後**：術後 12-24 小時即開始少量腸道餵食（1/4 RER），可維持腸黏膜屏障完整性、降低細菌移轉（bacterial translocation）風險，研究顯示可縮短住院天數 20-30%
- **再餵食症候群的致死性**：長期飢餓（> 5-7 天）動物突然恢復全量餵食可誘發急性低磷血症（< 2.0 mg/dL）→ 溶血、心律不整、呼吸衰竭 → 死亡，須從 25-50% RER 起始並密切監測電解質
- **營養途徑選擇的臨床決策**：鼻食管適合短期（3-7 天）但僅能灌注液態飲食；E-tube 適合中長期且飼主可在家操作；TPN 僅用於腸道完全不可用（短腸症候群、嚴重腸炎）且需住院監測
...
- **ASA 分級指導麻醉方案客製化**：ASA I-II 可使用標準方案（Acepromazine + Opioid → Propofol → Isoflurane），ASA III-V 需改用心血管影響較小的藥物組合（Midazolam + Fentanyl → Etomidate/Alfaxalone），不適當的藥物選擇可直接導致術中心跳停止
- **術中低血壓是最常見的致死性併發症**：MAP < 60 mmHg 持續超過 10 分鐘可造成急性腎損傷，犬的麻醉相關死亡率約 0.17%（ASA I-II）至 1-5%（ASA III-V），積極的液體治療與升壓藥介入可顯著改善預後
- **低體溫的隱性危害**：小型犬與貓因體表面積/體重比大，術中體溫下降速度快，低體溫（< 36°C）延長藥物代謝（甦醒時間增加 2-3 倍）、抑制凝血功能並增加 SSI 風險，術中應使用強制暖風毯（Bair Hugger）主動保溫
- **短鼻犬種的特殊麻醉風險**：法鬥、巴哥等短頭種犬因上呼吸道解剖異常，拔管後喉頭水腫與氣道阻塞風險極高，甦醒期應延遲拔管並備妥緊急氣切器材
- **多模式鎮痛（Multimodal Analgesia）**：結合 opioid（Methadone/Fentanyl CRI）+ NSAID（Meloxicam）+ 局部麻醉（Lidocaine splash block）可降低吸入麻醉劑 MAC 30-50%，減少心血管抑制並提供更完善的術後疼痛控制
...
- **GDV 的黃金急救時間**：胃擴張扭轉（GDV）是大型犬最致命的外科急診，從發病到手術的時間直接決定存活率——4 小時內手術存活率 > 85%，超過 6 小時胃壁壞死率急遽上升至 50% 以上，需同時進行胃固定術（gastropexy）預防復發
- **腸阻塞的手術時機決策**：線性異物（貓常見）可導致腸管鋸齒狀皺縮穿孔，X 光見「串珠狀」氣體分佈即應緊急手術；完全阻塞超過 24-48 小時腸壁全層壞死風險急升，術中需評估腸管活性決定切除範圍
- **腹膜炎的分類指導治療策略**：糞便性腹膜炎（腸穿孔）死亡率 50-74%，需緊急剖腹探查+腹腔灌洗+引流；膽汁性腹膜炎預後相對較佳（存活率 > 80%），但仍需手術處理原發漏點+腹腔引流
- **脾臟腫瘤破裂的「兩階段」臨床表現**：犬脾臟血管肉瘤（HSA）常表現為間歇性虛弱（小量滲血自行凝固）後突發急性休克（大量出血），FAST 超音波可在 2 分鐘內確認腹腔積液，PCV/TP 快速下降提示持續出血需緊急脾臟切除
- **術後缺血再灌流損傷**：GDV derotation 後大量 ROS 釋放可導致心室期外收縮（VPCs），術後 24-72 小時需持續 ECG 監測，R-on-T 現象或 VPC > 160 bpm 需 Lidocaine CRI 介入
...
- **固定方式選擇取決於癒合類型目標**：骨板螺絲提供剛性固定（absolute stability）促進直接癒合，適用於關節內骨折需解剖復位的情況；外固定架或髓內釘允許微動（relative stability）促進間接癒合伴骨痂形成，適用於長骨幹骨折
- **年齡與癒合速度的臨床應用**：幼犬骨膜活性高、癒合速度快（2-4 週），外固定架移除時間可較成犬（6-12 週）提前；但幼犬生長板仍開放，固定物跨越生長板可能導致生長畸形，須謹慎選擇固定策略
- **小型犬橈尺骨遠端骨折的高不癒合率**：Toy breed（約克夏、吉娃娃、博美）橈尺骨遠端骨折不癒合率高達 20%，因該區域血供差且軟組織覆蓋薄，建議使用鎖定骨板（locking plate）搭配自體海綿骨移植以提高癒合率
- **X 光判讀的陷阱**：骨板固定下的直接癒合不會產生可見骨痂，不應誤判為未癒合；反之，過度活動的外固定架下看到大量骨痂但不架橋（elephant foot appearance）則為肥厚性不癒合的典型表現
- **Diamond Concept 指導不癒合治療**：治療不癒合需系統性評估四要素——穩定性（更換或加強固定）、血供（骨移植帶入血管）、骨傳導支架（cancellous bone graft）、成骨因子（BMP），缺一不可
...
| 爭議議題 | 現況 | Evidence Level |
|---------|------|---------------|
| 犬骨折固定移除時機——常規移除 vs 僅在有併發症時移除 | 骨板常規移除可避免應力遮蔽下再骨折，但再手術有感染與醫源性骨折風險，目前無共識 | Level III |
...
- **體重管理是 OA 治療的第一優先**：研究顯示將 OA 犬體重降至理想 BCS（4-5/9）可減少 50% 以上的跛行嚴重度，效果不亞於 NSAIDs，在台灣小型犬過重問題普遍（尤其合併 MPL 的犬隻），減重應列為所有治療方案的基礎
- **原發病因的手術矯正決定長期預後**：CCLD 犬若僅使用 NSAIDs 保守治療，脛骨前移造成的持續機械不穩定將加速軟骨退化，TPLO 或 TTA 手術穩定膝關節可顯著延緩 OA 進展；MPL Grade III-IV 的手術矯正同理
- **NSAIDs 長期使用的安全監測**：Carprofen/Meloxicam 長期使用需每 3-6 個月監測肝腎功能（ALT、SDMA、UPC），貓對 NSAIDs 代謝較犬慢且腎毒性風險更高，Meloxicam 貓的長期使用劑量應降至 0.01-0.02 mg/kg/day
- **抗 NGF 抗體的臨床突破**：Bedinvetmab（犬）與 Frunevetmab（貓）提供不經肝腎代謝的全新鎮痛途徑，每月皮下注射一次，特別適合 NSAIDs 禁忌症動物（腎病、消化道潰瘍、凝血障礙）
- **多模式 OA 管理策略**：最佳 OA 控制需整合體重管理 + 運動處方（游泳、控制性散步）+ 藥物（NSAIDs 或抗 NGF）+ 關節保護品（Omega-3 EPA/DHA）+ 環境改善（止滑墊、低矮食碗、坡道），單一介入措施難以達到滿意效果
...
| MRI diffusion-weighted imaging (DWI) | 犬脊髓壓迫的功能性評估——區分水腫 vs 軟化壞死 | 人醫神經外科常規，獸醫 MRI 設備漸有 DWI 功能 |
...
| 犬 TPLO 術前是否常規需要 CT 測量——X 光 TPA 的準確性足夠嗎 | 標準側位 X 光 TPA 測量在多數病例足夠，但旋轉定位誤差可達 ± 3-5 度，複雜畸形肢體可能需 CT 3D 規劃，成本效益待評估 | Level III |
| 犬疑似骨肉瘤的影像診斷——是否需 CT/MRI 才能手術 | X 光典型表現已可高度疑診並進行截肢/limb-sparing，CT 對評估軟組織侵犯範圍與 limb-sparing 手術規劃有價值，但增加費用與麻醉次數 | Level III |`,
...
**腹腔鏡 vs 開腹手術**：腹腔鏡（如 OVE、預防性 gastropexy、隱睪摘除）具傷口小、術後疼痛低、恢復快的優勢，但需專用設備且學習曲線陡峭，複雜粘連或大型腫瘤仍以開腹為首選。
**血管封合裝置比較**：LigaSure（雙極電燒原理）可封合 ≤ 7 mm 血管，操作直覺且煙霧少；Harmonic（超音波原理）切割與封合同步，熱散布範圍較小（< 2 mm lateral thermal spread），但對大血管封合強度略遜於 LigaSure。
選擇依據：手術部位深度、血管口徑、及設備可用性綜合考量。

## 三、併發症與監控 (Complications & Monitoring)

**主要併發症**：吻合口洩漏（anastomotic dehiscence，犬腸切除吻合發生率約 6-16%，常於術後 3-5 天出現）、手術部位感染（SSI）、切口裂開（incisional dehiscence）、腹腔內出血（脾切除/肝葉切除後）。
**監控重點**：術後每 24 小時評估切口（紅腫、滲出、觸痛）；監測體溫（> 39.5°C 提示感染或 dehiscence）；觀察食慾與排便恢復時間；腸手術後追蹤 CRP 趨勢（術後 Day 3 未下降需警惕洩漏）。
**早期介入指標**：腹膜刺激徵、持續嘔吐、心搏過速合併低血壓提示需緊急再手術探查。

## 四、預後影響 (Prognostic Impact)

**脾臟切除術**：良性病灶（血腫、結節性增生）預後極佳，術後存活率 > 90%；惡性腫瘤（血管肉瘤 hemangiosarcoma）預後差，中位存活時間僅 1-3 個月（單純手術）至 4-6 個月（手術 + 化療）。
**腸切除吻合**：切除邊緣足夠（≥ 1-2 cm）且無術中汙染者預後良好（存活率 > 80%）；腫瘤性切除需評估組織學邊緣——完全切除預後顯著優於邊緣不清者。
**整體影響因子**：術前低白蛋白血症（< 2.0 g/dL）、腹膜炎存在、及手術時間過長（> 3 小時）為獨立不良預後因子。
...
**主要併發症**：植入物失敗（螺釘鬆脫、骨板彎曲/斷裂，發生率約 2-7%）、手術部位感染（骨科 SSI 率約 3-6%，植入物存在時更難根治）、延遲癒合（delayed union > 預期時間 1.5 倍）與不癒合（nonunion）、漿液腫（seroma，尤其 TPLO 內側切口）。
**監控重點**：術後負重評估（weight-bearing assessment）——正常犬應於 2-4 週開始部分負重；術後 6-8 週追蹤 X 光評估骨痂形成與植入物位置；每週觸診切口與釘道（ESF）有無紅腫滲出。
**警示徵兆**：持續或惡化的跛行、切口持續滲液 > 5 天、X 光顯示植入物位移或骨溶解（osteolysis），需考慮翻修手術。

## 四、預後影響 (Prognostic Impact)

**TPLO**：長期功能結果良好至優異（90-95% 飼主滿意度），多數犬於 8-12 週恢復正常活動；半月板併發損傷會降低預後評分。
**骨折癒合率**：簡單骨折（transverse/short oblique）以骨板固定癒合率 > 95%；粉碎性骨折（comminuted）癒合時間延長且不癒合風險升至 5-10%；橈尺骨遠端骨折（尤其玩具犬種）不癒合率最高可達 18%。
**FHO 功能預後**：體重 < 15 kg 的犬貓多數恢復良好的日常活動功能；體重較大的犬功能恢復較差，積極復健（水療 + 被動關節活動）可顯著改善預後。
...
| 骨科術後復健醫學（水療、TENS、therapeutic ultrasound） | 犬骨科術後功能恢復加速——客觀化步態分析指導復健 | 獸醫復健專科快速成長，台灣認證復健師增加中 |
...
| 爭議議題 | 現況 | Evidence Level |
|---------|------|---------------|
| 犬 TPLO vs TTA——長期功能結果是否有差異 | 多數回顧性研究顯示兩者術後 6-12 個月功能結果相當，但 TPA > 30 度時 TPLO 可能較優，缺乏大型前瞻性 RCT | Level II |
...
**ERAS（加速康復外科）vs 傳統術後照護**：ERAS protocol 整合術前禁食縮短（犬 2-4 小時清澈液體）、預防性止吐（maropitant）、限制性輸液、早期腸內營養（術後 12 小時）與早期活動，可縮短住院天數 30-50%；傳統方法傾向保守禁食、自由輸液、延遲餵食，恢復較慢但操作簡單。
**多模式鎮痛 vs 單一藥物止痛**：多模式鎮痛（NSAIDs + opioid + local block ± ketamine CRI）透過不同疼痛路徑協同作用，可降低各藥物劑量並減少副作用；單一藥物（如僅用 opioid）鎮痛效果受限且副作用（鎮靜、呼吸抑制、腸蠕動抑制）更顯著。
目前獸醫共識強烈推薦多模式鎮痛作為標準照護。

## 三、併發症與監控 (Complications & Monitoring)

**主要併發症**：術後噁心嘔吐（PONV，犬發生率約 10-20%，以 maropitant 預防）、手術部位感染（SSI，依傷口分類風險不同）、術後腸蠕動遲滯（ileus，尤其腹腔手術後）、尿滯留（骨盆手術或 opioid 影響）、術後低體溫（體溫 < 37°C 增加 SSI 與凝血異常風險）。
...
**介入指標**：疼痛評分超過干預閾值需追加鎮痛（Glasgow ≥ 6/24, CSU ≥ 2/4）；體溫 > 39.5°C 或 < 37°C 需積極處理。

## 四、預後影響 (Prognostic Impact)

**傷口分類與併發症率**：Clean（I 級）手術 SSI 率 2-5%，預後極佳；Clean-contaminated（II 級）SSI 率 5-10%；Contaminated（III 級）SSI 率 10-20%；Dirty（IV 級）SSI 率 > 20%，且整體併發症率與住院時間顯著增加。
...
**監控重點**：Culture & Sensitivity（C&S）追蹤——治療性抗菌 72 小時後若臨床無改善需重新評估；WBC 趨勢（下降提示治療有效，上升或不降需調整方案）；切口每日評估感染徵兆（紅腫、熱感、膿性滲出）。
...
**療程長度影響**：Clean 手術預防性抗生素限於術中（≤ 24 小時）與延長 5-7 天相比，SSI 率無統計學差異，但延長用藥顯著增加抗藥性風險。
**MRSP 感染預後**：MRSP 造成的 SSI 治療選擇極為有限（常需 chloramphenicol、rifampin 或 amikacin），治療療程延長且費用顯著增加，嚴格無菌技術與合理用藥策略是最關鍵的預防措施。
...
| 快速分子診斷（mecA PCR / MALDI-TOF） | 犬 SSI 致病菌的快速鑑定與抗藥性偵測——縮短培養等待時間 | 人醫實驗室已常規化，獸醫大型參考實驗室引入中 |
...
| 爭議議題 | 現況 | Evidence Level |
|---------|------|---------------|
| 犬 Clean 手術是否需要預防性抗生素——絕育/gastropexy 等低風險手術 | 多數指引建議 Clean 手術仍給予單劑 cefazolin，但部分研究顯示不給藥 SSI 率無顯著差異，是否可安全省略仍待更大樣本驗證 | Level II |
