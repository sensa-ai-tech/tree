...
| GOLPP 犬的手術時機：早期介入 vs 等症狀惡化 | 早期手術呼吸改善好，但暴露在吸入性肺炎風險中更久，最佳時機還有爭議 | Level IV |`,
  ...
  references: [
    { type: 'journal', citation: 'Stanley BJ et al. Canine idiopathic laryngeal paralysis as one sign of a diffuse polyneuropathy: an observational study of 90 cases. Vet Surg 2010;39(8):1-8.', relevance: '⚠️ 待 DVM 查證：作者/年/標題/頁碼互相矛盾——標題吻合者為 Bookbinder 2016 Vet Surg 45(2):254-260 `10.1111/vsu.12444`，作者/年吻合者為 Stanley 2010 Vet Surg 39(2):139-149（食道功能異常，非 LP-polyneuropathy）；DVM 擇定原意圖來源' },
...
`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Brunson DB, Hogan KJ. Malignant hyperthermia: a syndrome not a disease. Vet Clin North Am Small Anim Pract. 2004;34(6):1419-1433.', relevance: 'MH 機轉與臨床綜述' },
    { type: 'journal', citation: 'Roberts MC et al. Autosomal dominant canine malignant hyperthermia is caused by a mutation in the gene encoding the skeletal muscle calcium release channel (RYR1). Anesthesiology. 2001;95(3):716-725.', relevance: '犬 RYR1 突變確認研究' },
  ],
  is_current: true,
  created_at: now,
};
...
`,
  ...
  references: [
    ...
    { type: 'guideline', citation: 'Holmstrom SE, Bellows J, Juriga S, et al. 2013 AAHA Dental Care Guidelines for Dogs and Cats. J Am Anim Hosp Assoc. 2013;49(2):75-82.', relevance: '奠基性指引（2020 前）：確立牙科處置須全麻插管、免麻醉洗牙低於照護標準，供與 2019 版對照' },
  ],
  is_current: true,
  created_at: now,
};
