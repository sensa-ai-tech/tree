...
export const CROSS_SPECIALTY_EDGES: KnowledgeEdge[] = [
  ...
  // ─── 2026-06-07 iter 4: MDR1 (ABCB1-1Δ) 跨科邊 (IM-L3-030) ───
  {
    id: 'CROSS-IM-ONCO-MDR1-CHEMO-001',
    source_node_id: 'IM-L3-030',
    target_node_id: 'ONCO-L5-001',
    relation_type: 'drug_related',
    weight: 0.95,
    description: 'MDR1 突變犬使用 vincristine、vinblastine、doxorubicin、paclitaxel 等 P-gp 受質化療藥時，BBB 滲漏放大神經毒性與骨髓抑制。所有牧羊犬血統開始化療前應做 ABCB1 基因檢測，純合子建議劑量減 25-50% 並加強 G-CSF 預防、CBC q3-7d 監測。',
    bidirectional: false,
    unlock_condition: null,
  },
  {
    id: 'CROSS-IM-NEURO-MDR1-ENCEPH-001',
    source_node_id: 'IM-L3-030',
    target_node_id: 'NEURO-L2-005',
    relation_type: 'differential',
    weight: 0.85,
    description: 'Ivermectin 中毒急性表現與高血壓性腦病、肝腦症、原發性 CNS 疾病必須鑑別。鑑別關鍵：牧羊犬品種、ivermectin/loperamide 用藥史、雙側瞳孔散大但對光反射可能保留、MRI 通常正常、BP 正常。治療：MDR1 中毒 → IV lipid emulsion；其他原因 → 個別處置。',
    bidirectional: true,
    unlock_condition: null,
  },
  {
    id: 'CROSS-IM-CARDIO-MDR1-HW-PREVENT-001',
    source_node_id: 'IM-L3-030',
    target_node_id: 'CARDIO-L3-005',
    relation_type: 'drug_related',
    weight: 0.9,
    description: 'MDR1 突變犬使用心絲蟲預防劑「安全性」的關鍵教育：FDA 核准的犬用心絲蟲預防劑以預防劑量 (ivermectin 6 μg/kg/月) 對所有 MDR1 基因型完全安全；致毒需 >50× 此劑量。台灣心絲蟲死亡率遠高於 MDR1 中毒風險。絕對禁忌：牛羊用驅蟲劑、外用大動物 ivermectin 滴劑、馬用 ivermectin paste。',
    bidirectional: false,
    unlock_condition: null,
  },
  {
    id: 'CROSS-IM-ECC-MDR1-ILE-001',
    source_node_id: 'IM-L3-030',
    target_node_id: 'ECC-L5-001',
    relation_type: 'clinical_apply',
    weight: 0.95,
    description: 'IV lipid emulsion (ILE) 是 MDR1 中毒首選解救：20% Intralipid/SMOFlipid，1.5 mL/kg slow IV bolus → 0.25 mL/kg/min CRI × 30-60 min（單日上限 8 mL/kg），q4-6h 可重複。機轉：脂溶性毒物在血中被脂肪相吸附形成 lipid sink、從 CNS 反向擴散。Wright 2011 案例系列顯示 ILE 介入 4-6h 內康復率 >90%。',
    bidirectional: true,
    unlock_condition: null,
  },
