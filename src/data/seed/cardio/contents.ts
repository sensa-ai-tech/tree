...
const contentOverview: NodeContent = {
  ...
  key_points: [
    ...
    '台灣是心絲蟲高盛行區，預防工作不能省',
    '聽診是門診最基本、也最有用的篩檢工具',
    '心臟超音波（echocardiography）才是確診金標準',
  ],
  body: `# 獸醫心臟科總覽

## 一、核心概念與機轉 (Core Concept & Mechanism)

獸醫心臟科處理的是伴侶動物的心血管問題，範圍從聽診、影像判讀，一路到藥物治療與居家追蹤。這份知識樹分成六層走，從解剖基礎一路推到臨床決策：
...
台灣亞熱帶氣候，蚊子一年到頭都在飛，心絲蟲一直壓不下來。沒做預防的犬隻陽性率落在 20% 到 40% 之間，南部又比北部嚴重。[藥物:Ivermectin] 那類預防藥得整年吃滿，不要因為「冬天蚊子少」就停藥。這幾年飼主健檢意識上來，小型犬 MMVD 跟貓 HCM 的早期篩檢做得比以前勤，門診看到 B1、B2 的比例也多了起來。
...
每隻來看診的犬貓，聽診四個位置不要省。X 光要會抓 VHS 跟肺水腫的型態。ECG 至少能讀出心率、節律、有沒有 VPC 跑出來。急性 CHF 進來，氧氣、Furosemide IV、貓還要會抽胸水。最後是飼主教育，sleeping RR 怎麼算、什麼時候該掛急診，要當場示範一次給飼主看。這幾項做到位，基層其實能 cover 大部分心臟病例。
...
[圖片:犬貓常見心臟病分佈圓餅圖]`,
  clinical_pearl: '每隻動物理學檢查都要聽診，年輕健康的也不能跳過。聽到雜音就要追下去，不要假設是「應該還好」。早一年抓到，治療空間差很多。',
  common_mistakes: [
  ...
  references: [
    ...
    { type: 'guideline', citation: 'Keene BW, Atkins CE, Bonagura JD, et al. "ACVIM consensus guidelines for the diagnosis and treatment of myxomatous mitral valve disease in dogs." J Vet Intern Med. 2019;33(3):1127-1140. doi:10.1111/jvim.15488', relevance: 'MMVD 診斷與治療共識指引（Crossref 驗證）' },
    { type: 'journal', citation: 'Atkins C et al. Guidelines for the diagnosis and treatment of canine chronic valvular heart disease. J Vet Intern Med. 2009;23(6):1142-1150. doi:10.1111/j.1939-1676.2009.0392.x', relevance: '犬慢性瓣膜性心臟病診斷與治療文獻' },
...
### 分子層級（已確認的部分）
瓣膜上的間質細胞（valvular interstitial cells, VICs）會轉型成活化型肌纖維母細胞，開始分泌過量的 MMP-1 跟 MMP-13，把膠原蛋白拆掉，同時讓糖胺聚醣（GAGs）異常堆積。TGF-β 跟 serotonin（5-HT）這兩條訊號通路是上游推手。CKCS 已經確認是多基因遺傳，所以這個品種不是「會不會發」的問題，是「幾歲發」的問題。

### 細胞到組織的傳導
VICs 一活化，瓣膜海綿層（spongiosa）就開始堆 GAGs，纖維層（fibrosa）的膠原結構被打散，瓣膜變厚、脫垂，腱索也跟著延長，嚴重的會斷掉。

### 器官到全身的代償
瓣膜關不緊（MR）之後，左心房先承受逆流的壓力跟容量。LA 撐大，肺靜脈壓往上爬，左心室也跟著離心性肥大。RAAS 跟交感神經這時候會啟動代償，本意是維持血壓，結果反而把鈉水留下來，最後就是肺水腫，臨床上就是 CHF。

打個比方：瓣膜就像水龍頭的止水墊片，老化之後關不緊，水會回滲。下游的水管（左心房）承受壓力越來越大，最後就漏給肺臟。

### 還沒定論的部分
循環中的 serotonin 到底是不是獨立致病因子，目前還在吵。瓣膜內新生血管的角色也說不清楚。至於基因治療或 MMP 抑制劑，現階段都還在實驗室。
...
有四到五成的個案在確診當下根本沒症狀，只是健檢聽到雜音才被抓出來，這時候多半是 B1 或 B2。另一種比較棘手的是急性腱索斷裂，前一天還好好的，隔天直接送來 CHF。也有少數合併肺高壓，右心衰竭跑在前面，臨床看到的是腹水跟頸靜脈怒張。

### 記住「MMVD 5C」就夠用

CKCS 好發、Cough（咳嗽）、Cardiomegaly（心臟擴大）、CHF（心衰竭）、Check sleeping RR（飼主居家算呼吸）。看診遇到中老年小型犬有雜音，腦袋裡 5C 就會自動跑出來。
...
Furosemide 用久了脫水、低鉀、氮血症都會跑出來，所以每次回診都要追腎指數跟電解質。ACE inhibitor 主要是低血壓跟氮血症，老年犬尤其要小心。Pimobendan 副作用算少，偶爾遇到食慾下降或軟便，多半不嚴重。
...
早期就抓到、B2 就把 Pimobendan 加上去、體型小、飼主肯吃藥也肯記呼吸次數，sleeping RR 長期穩定在 25 以下，這幾條湊齊預後通常都不錯。

### 反過來幾個紅旗

腱索突然斷掉、心房顫動跑出來、肺高壓嚴重（TR velocity 衝到 3.5 m/s 以上）、腎功能往下走（BUN 越過 60 mg/dL）、NT-proBNP 一路向上，這些都是要提高警覺的訊號。臨床上看到兩三個一起出現，就得跟飼主開預後對話了。
...
MMVD 是會慢慢進展的慢性病，治不好但能管。跟飼主要講清楚四件事。第一，藥不能停、不能忘。第二，每天睡覺時數一次呼吸，記在本子上或手機 app。第三，sleeping RR 超過 30 或喘成那樣，不要等隔天，當下就掛急診。第四，如果走到 C 或 D 期，外科瓣膜修復在日本跟歐美成功率已經超過九成，可以當成選項討論，雖然台灣管道有限但越來越多人在送出國做。
...
幾個方向值得追。犬 MMVD 的 GWAS 在找遺傳標記，理論上有機會做到產前篩檢。Sacubitril/Valsartan 的多中心 RCT 也在進行。術前規劃這邊 3D 列印瓣膜模型已經有醫院在試。幹細胞治療退化瓣膜還在很前期，離臨床應用很遠。

[圖片:MMVD 分期治療流程圖]`,
  clinical_pearl: '雜音多大聲跟病多嚴重不一定成正比。臨床上看過 Grade II/VI 的雜音其實已經 B2，也看過 Grade V/VI 的犬穩穩過好幾年。聽診是初篩，分期還是要靠心超加 X 光。',
  common_mistakes: [
    '只聽雜音就斷嚴重度，沒安排心超',
    'B1 就開始用 pimobendan（EPIC 研究只支持 B2 以上）',
    '飼主沒被教 sleeping RR 怎麼算，居家監測等於沒做',
    'MMVD 引起的咳嗽被誤認成呼吸道感染',
  ],
  disease_data: {
    ...
    owner_communication: 'MMVD 是會慢慢進展的慢性病，治不好但可以好好管。重點在早抓、定期追、按時吃藥。要當場教飼主怎麼算 sleeping RR，告訴他超過 30 次或喘起來就直接掛急診，不要等隔天。藥不能停這件事要講三次。',
  },
  diagnostic_data: null,
  procedure_data: null,
  visual_placeholders: [
  ...
  references: [
    { type: 'guideline', citation: 'Keene BW et al. ACVIM consensus guidelines for the diagnosis and treatment of myxomatous mitral valve disease in dogs. J Vet Intern Med. 2019;33(3):1127-1140. doi:10.1111/jvim.15488', relevance: '最新 MMVD 診斷治療共識（2026 年止無更新版）' },
    { type: 'journal', citation: 'Boswood A et al. Effect of pimobendan in dogs with preclinical myxomatous mitral valve disease and cardiomegaly: the EPIC study. J Vet Intern Med. 2016;30(6):1765-1779. doi:10.1111/jvim.14586', relevance: 'Pimobendan 用於 B2 期的關鍵證據' },
    { type: 'journal', citation: 'Coffman M et al. Benazepril and spironolactone in dogs with congestive heart failure caused by MMVD (BESST study). J Vet Intern Med. 2021;35(4):1673-1687. doi:10.1111/jvim.16155', relevance: 'C 期加入 spironolactone 的實證（2026-06 更新）' },
    { type: 'journal', citation: 'Borgarelli M et al. Delay of appearance of symptoms of canine degenerative mitral valve disease treated with spironolactone and benazepril: the DELAY study. J Vet Cardiol. 2020;27:34-53. doi:10.1016/j.jvc.2019.12.002.', relevance: 'B2 期 RAASi 延緩效益未達顯著（2026-06 更新；DELAY 全名，對齊 DOI 標題）' },
    ...
    { type: 'guideline', citation: 'Reinero C et al. ACVIM consensus statement guidelines for the diagnosis, classification, treatment, and monitoring of pulmonary hypertension in dogs. J Vet Intern Med. 2020;34(2):549-573. doi:10.1111/jvim.15725', relevance: 'MMVD-PH 與 sildenafil 使用框架（2026-06 更新）' },
...
> 臨床內容與藥物劑量需獸醫師依現行仿單與指引核對；本節點為 AI 接地生成，停於 review 狀態待 DVM 簽核。`,
  ...
  diagnostic_data: {
    ...
    cost_benefit: '成本低到不行，一支聽診器就搞定，任何診間都能做。當篩檢工具 CP 值極高，後面要不要安排心超、X 光，多半就看聽診當下抓到什麼。',
  },
  procedure_data: null,
  visual_placeholders: [
...
### 記憶框架，「DCM-RAPID」
- Remodeling（離心性重塑）
- Arrhythmia（心律不整，VPCs, VT, AF）
- Progressive（進行性且不可逆）
- Idiopathic/Inherited（原發/遺傳為主）
- Dilation（心腔擴大、壁變薄）
...
[圖片:DCM 心超影像，擴大的左心室與降低的 FS]`,
  ...
  disease_data: {
    ...
    differential_diagnosis: [
      ...
      { condition: '心肌炎', key_differentiator: '通常急性發病，可能有感染病史（Trypanosoma, Parvovirus），心肌酵素（cTnI）明顯升高' },
  ...
  references: [
    ...
    { type: 'journal', citation: 'Wess G et al. Evaluation of N-terminal pro-B-type natriuretic peptide as a diagnostic marker of various stages of cardiomyopathy in Doberman Pinschers. Am J Vet Res. 2011;72(5):642-649. doi:10.2460/ajvr.72.5.642', relevance: '杜賓犬 DCM 分期與 NT-proBNP 診斷價值' },
...
### 記憶框架，「HCM-CLOT」
- Cardiomyopathy（原發性心肌病，排除續發）
- Left ventricular hypertrophy（≥6mm，核心標準）
- Obstruction（SAM/LVOTO，動態性）
- Thromboembolism（ATE，最致命併發症）
...
[圖片:HCM 心超影像，左心室壁肥厚與 SAM 現象]`,
  ...
  disease_data: {
    ...
    prognosis: '個體差異極大。無症狀 HCM 中位存活可達 > 5 年（部分終身無症狀）。出現 CHF 後中位存活約 12-18 個月（有效治療下）。ATE 發作後預後差：急性期死亡/安樂死率約 35-50%，存活者中位存活約 6-12 個月，復發率約 25-50%。不良預後因子：LA 明顯擴大（LA/Ao > 2.0）、SEC、ATE 病史、心房顫動、end-stage（收縮功能衰退）。',
  ...
  references: [
    ...
    { type: 'journal', citation: 'Kittleson MD et al. Familial hypertrophic cardiomyopathy in Maine Coon cats: an animal model of human disease. Circulation. 1999;99(24):3172-3180. doi:10.1161/01.cir.99.24.3172', relevance: '緬因貓 HCM 遺傳學經典研究（Crossref 驗證）' },
  ],
  is_current: true,
  created_at: now,
};
...
- Effusion（確認液體存在，TFAST）
- Tamponade（壓塞=急症）
- Aetiology（穿刺後找病因，腫瘤 vs 特發性）
- Plan（穿刺→引流→送檢→長期計畫）
...
重點式心臟超音波（TFAST/POCUS）讓急診第一線即可快速辨識心包膜積液與壓塞徵象（右心房舒張期塌陷），縮短到引流的時間；AI 輔助判讀亦在初步驗證中。`,
  ...
  common_mistakes: [
    ...
    '對 HSA 來源 PE 過度樂觀，即使穿刺引流後臨床改善明顯，HSA 的長期預後仍很差',
  ],
  disease_data: {
...
const contentCardiacAnatomy: NodeContent = {
  ...
  version: 1,
  summary: '心臟解剖是後面所有心血管疾病的底子。犬貓心臟都是四腔室，住在縱膈腔。犬的心臟大概佔胸腔寬度 2.5 到 3.5 個肋間，貓的相對小一點。腔室、瓣膜、冠狀動脈、傳導系統，這幾塊的位置要熟，後面聽診定位、X 光判讀、開刀走哪個切口才不會卡住。',
  learning_objectives: [
    '描述犬貓心臟四腔室的解剖位置與相互關係',
    '辨識四組心臟瓣膜的位置、結構與功能',
    '說明冠狀動脈的走行與主要分支供血區域',
...
代償期 → 能量需求持續增加 → 粒線體功能障礙 → ATP 生成不足 → 鈣離子處理蛋白（SERCA2a）功能下降 → 收縮-舒張偶聯異常 → 心肌細胞凋亡增加 → 收縮力衰退 → 心輸出量下降 → 後續神經荷爾蒙活化 → 惡性循環。
...
[圖片:離心性 vs 同心性肥大的肌小節排列差異示意圖]`,
  ...
  references: [
    { type: 'journal', citation: 'Keene BW et al. ACVIM consensus guidelines for the diagnosis and treatment of myxomatous mitral valve disease in dogs. J Vet Intern Med. 2019;33(3):1127-1140. doi:10.1111/jvim.15488', relevance: 'MMVD 相關心肌重塑與治療共識' },
    ...
    { type: 'journal', citation: 'Oyama MA, Levy RJ. Insights into serotonin signaling mechanisms associated with canine degenerative mitral valve disease. J Vet Intern Med. 2010;24(1):27-36. doi:10.1111/j.1939-1676.2009.0411.x', relevance: '犬瓣膜退化與重塑的分子機轉' },
...
#### 交感神經系統 (SNS)
心輸出量↓ → 壓力感受器反射 → NE/Epi 釋放 → β1（↑HR + ↑收縮力）+ α1（血管收縮）。短期維持灌流，長期導致心肌氧耗↑、心律不整、後續重塑。
...
[圖片:心輸出量決定因素與 Frank-Starling 曲線示意圖]`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Boswood A. Current use of pimobendan in canine patients with heart disease. Vet Clin North Am Small Anim Pract. 2010;40(4):571-580. doi:10.1016/j.cvsm.2010.04.003', relevance: 'Pimobendan 血流動力學作用機轉文獻' },
    { type: 'guideline', citation: 'Keene BW, Atkins CE, Bonagura JD, et al. "ACVIM consensus guidelines for the diagnosis and treatment of myxomatous mitral valve disease in dogs." J Vet Intern Med. 2019;33(3):1127-1140. doi:10.1111/jvim.15488', relevance: 'MMVD 診斷與治療共識指引（Crossref 驗證）' },
  ],
  is_current: true,
  created_at: now,
...
貓在脫水/容積不足時左心室腔變小、室壁相對「增厚」為假性肥厚（pseudohypertrophy），與真正 HCM 不同；應在補液、心率穩定後複評，避免過度診斷 HCM。`,
  ...
  diagnostic_data: {
    ...
    normal_findings: [
      { finding: 'LA/Ao < 1.6（犬）', description: '左心房與主動脈根部比值在正常範圍', significance: '排除左心房明顯擴大' },
    ...
    interpretation_guide: '1. 2D 把各腔室大小、心肌厚度、瓣膜結構、心包膜整個掃過一遍。2. M-mode 測量 LVIDd/s、FS、EPSS。3. 2D 心底短軸測量 LA/Ao。4. Color Doppler 評估各瓣膜逆流。5. PW Doppler 測量二尖瓣 E/A ratio。6. CW Doppler 測量 TR 速度估算肺動脈壓。7. 把所有數據合起來判定診斷與分期。',
    pitfalls: [
      '肥胖動物超音波穿透力差，影像品質下降',
    ...
    cost_benefit: '成本中等（要儀器也要訓練），但診斷價值非常高。MMVD 要分 B1 還 B2、DCM 要確診、HCM 要評估，全部都靠心超。臨床建議：心雜音聽到 Grade III 以上的犬貓，就把心超排上去。',
  },
  procedure_data: null,
  visual_placeholders: [
...
[圖片:犬正常 ECG 與各種心律不整 ECG 波形對比]`,
  ...
  diagnostic_data: {
    ...
    cost_benefit: '成本低，ECG 機算便宜，操作也單純。心律不整診斷靠它沒問題，但腔室大小評估有限，得搭心超才看得清楚。Holter 成本拉高，可是要抓間歇性心律不整就少不了，省這筆很可能漏診。',
  },
  procedure_data: null,
  visual_placeholders: [
...
床邊肺超音波 B-lines 對心因性肺水腫可能較 X 光更早偵測；急診常 X 光 + POCUS 並用，惟 B-line 特異度（心因 vs 非心因）仍待釐清。`,
  ...
  diagnostic_data: {
    ...
    normal_findings: [
      { finding: 'VHS < 10.5（犬）', description: '心臟大小在正常範圍', significance: '排除明顯心臟增大' },
      ...
      { finding: '隆突角正常', description: '左右主支氣管角度正常（犬約 60-70 度）', significance: '排除左心房明顯擴大' },
    ],
    abnormal_findings: [
      { finding: 'VHS > 10.5', description: '心臟大小超過正常範圍', significance: '提示心臟增大，需心超後續評估，是 MMVD B2 分期標準之一' },
...
| MMVD CHF MST | EPIC 研究 ~267 天 | Stage D 難治型明顯縮短 |
...
[圖片:Vaughan-Williams 分類與臨床選藥對應流程圖]`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Meurs KM et al. Comparison of the effects of four antiarrhythmic treatments for familial ventricular arrhythmias in Boxers. J Am Vet Med Assoc. 2002;221(4):522-527. doi:10.2460/javma.2002.221.522', relevance: '犬抗心律不整藥物療效比較（Crossref 驗證）' },
...
- 輕度 SAS 的心雜音可能被誤認為「功能性雜音（innocent murmur）」，在好發品種中，任何收縮期雜音都應後續心超評估
...
[圖片:心臟胚胎發育時序與常見先天性缺陷對應圖]`,
  clinical_pearl: '先天性心臟病早期抓到差很多。PDA 在還沒走到心衰之前做掉（外科結紮或 ACDO 封堵），預後跟正常犬幾乎沒差。但一旦走到 Eisenmenger syndrome（肺高壓搞到右往左分流、開始發紺），手術就不能做了。所以幼犬第一次來打疫苗那次，聽診一定要認真做。PDA 的連續性「機械樣」雜音在左腋下最明顯，聽到就直接轉專科，不要拖。\n\n台灣小型犬飼養比例高，PDA 是最常碰到的先天性心臟病。這幾年台大、亞洲、瑞鵬等幾家教學醫院都引進 ACDO（Amplatz Canine Duct Occluder）封堵技術，PDA 不用一定開胸。PS 的球囊擴張現在也算普及了。',
  common_mistakes: [
    '把先天性心雜音當「功能性」就放掉。好發品種聽到收縮期雜音，SAS、PS 一定要先用心超排除',
    '忘了 PDA 也有逆向（reverse PDA）。後肢 PaO₂ 比前肢低的差異性發紺就是它的招牌',
    '英國鬥牛犬的 PS 不要一律建議球囊擴張。dysplastic type 對球囊反應很差，先用心超看型態才決定',
    'PRAA 手術完飼主以為就沒事了。其實有些犬的食道擴張是永久的，巨食道的長期管理還是要顧',
  ],
  disease_data: null,
  diagnostic_data: null,
  procedure_data: null,
  ...
  references: [
    ...
    { type: 'guideline', citation: 'Bussadori C, Amberger C, Le Bobinnec G, Lombard CW. Guidelines for the echocardiographic studies of suspected subaortic and pulmonic stenosis. J Vet Cardiol. 2000;2(1):15-22. doi:10.1016/s1760-2734(06)70007-8', relevance: 'SAS 與 PS 超音波診斷指引' },
    { type: 'journal', citation: 'Oliveira P et al. Retrospective review of congenital heart disease in 976 dogs. J Vet Intern Med. 2011;25(3):477-483. doi:10.1111/j.1939-1676.2011.0711.x', relevance: '犬先天性心臟病回溯性流行病學研究' },
  ],
  is_current: true,
  created_at: now,
};
...
未治療自然病程：約 60% 在 1 歲前發展充血性心衰竭（CHF），中位存活時間明顯縮短。
...
術後預後：早期閉合（CHF 前）預後極佳，心臟可逆性重塑，壽命接近正常。已有 CHF 者閉合後仍可明顯改善，但可能需持續心臟藥物。
...
| 要素 | 貓心肌病中的表現 | 機轉 |
|------|----------------|------|
| 血流淤滯 | 左心房擴大→心耳內血流速度下降→自發性回聲（smoke） | LA/Ao ≥ 2.0 時風險明顯增加 |
...
急性缺血 → 組織 ATP 耗竭 → 細胞損傷/壞死 → 鉀離子與肌紅蛋白釋放。再灌流時（若血栓自溶或溶栓治療）→ 活性氧族（ROS）大量產生 → 後續組織損傷 → 高鉀血症 + 肌紅蛋白尿 + 代謝性酸中毒 → 再灌流致死（reperfusion injury/death）。
...
| Pulselessness（無脈搏） | 股動脈觸診 | 患肢股動脈脈搏消失或明顯減弱 |
...
3. 血液檢查，CK 明顯升高（肌肉壞死）、高鉀血症、代謝性酸中毒、氮血症
...
| 藥物 | 劑量 | 證據 |
|------|------|------|
| [藥物:Clopidogrel] | 18.75 mg/cat PO SID | FAT CAT 研究（2015）：Clopidogrel 明顯優於 Aspirin（復發中位時間 443d vs 192d） |
...
[圖片:貓 ATE 5 Ps 臨床評估圖，肉墊顏色比較與脈搏觸診]`,
  ...
  common_mistakes: [
    ...
    '使用 Aspirin 而非 Clopidogrel 作為二級預防，FAT CAT 研究已證實 Clopidogrel 明顯優於 Aspirin',
  ...
  disease_data: {
    ...
    pathogenesis: 'Virchow triad：(1) 血流淤滯（LA 擴大→心耳血流速↓）+ (2) 內皮損傷（心肌病相關）+ (3) 高凝血狀態（貓血小板高反應性）→ 左心房血栓形成 → 脫落 → 栓塞至主動脈分叉（70-75%，saddle thrombus）→ 遠端組織急性缺血 → 肌肉壞死（CK↑）+ 高鉀血症 + 代謝性酸中毒。再灌流時 ROS 大量產生→後續組織損傷。',
    clinical_signs: [
      ...
      { sign: '股動脈脈搏消失', category: 'primary', description: '觸診患側股動脈無脈搏或明顯減弱' },
    ...
    diagnostic_workup: '1. 理學檢查，5 Ps 快速評估（股動脈脈搏、肉墊顏色/溫度、神經學檢查）→ 2. 血液檢查，CK（明顯升高，通常 >10,000 U/L）、K⁺（高鉀風險）、BUN/Cre、Lactate、血氣（代謝性酸中毒）→ 3. 心臟超音波，確認心肌病（HCM/UCM/RCM/DCM）、LA 大小、左心耳血栓/smoke → 4. 胸腔 X 光，心臟大小、肺水腫/胸水評估 → 5. 杜卜勒超音波（可選），確認動脈血流中斷位置',
