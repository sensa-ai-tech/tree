...
export const CARDIO_EDGES: KnowledgeEdge[] = [
  ...
  { id: 'CARDIO-E-053', source_node_id: 'CARDIO-L2-001', target_node_id: 'CARDIO-L3-001', relation_type: 'prerequisite', weight: 1, description: '瓣膜退化機轉是理解 MMVD 黏液瘤性退化的必要前置知識', bidirectional: false, unlock_condition: null },
  // CARDIO-L3-002 (DCM) ← L2-002 (心肌重塑機轉)
  { id: 'CARDIO-E-054', source_node_id: 'CARDIO-L2-002', target_node_id: 'CARDIO-L3-002', relation_type: 'prerequisite', weight: 1, description: '心肌重塑機轉是理解擴張型心肌病心室擴大與收縮功能下降的前置知識', bidirectional: false, unlock_condition: null },
  // CARDIO-L3-003 (HCM) ← L1-003 (心臟血流動力學)
  { id: 'CARDIO-E-055', source_node_id: 'CARDIO-L1-003', target_node_id: 'CARDIO-L3-003', relation_type: 'prerequisite', weight: 1, description: '心臟血流動力學是理解 HCM 舒張功能障礙與流出道阻塞的前置知識', bidirectional: false, unlock_condition: null },
