...
export const CARDIO_NODES: KnowledgeNode[] = [
  // Layer 0: 學科總覽
  ...
  { id: 'CARDIO-L1-003', specialty: 'CARDIO', title: '心臟血流動力學', title_en: 'Cardiac Hemodynamics', layer: 1, node_type: 'mechanism', difficulty: 2, estimated_minutes: 20, clinical_relevance: 4, exam_relevance: 3, status: 'published', version: 1, tags: ['血流動力學', '生理'], encyclopedia_link: null, cross_specialty_notes: null, created_at: now, updated_at: now },
  ...
  { id: 'CARDIO-L2-003', specialty: 'CARDIO', title: '心律不整機轉', title_en: 'Arrhythmia Pathogenesis', layer: 2, node_type: 'mechanism', difficulty: 3, estimated_minutes: 25, clinical_relevance: 5, exam_relevance: 4, status: 'published', version: 1, tags: ['心律不整', '電生理'], encyclopedia_link: null, cross_specialty_notes: null, created_at: now, updated_at: now },
  ...
  { id: 'CARDIO-L3-004', specialty: 'CARDIO', title: '心包膜積液', title_en: 'Pericardial Effusion', layer: 3, node_type: 'disease', difficulty: 4, estimated_minutes: 25, clinical_relevance: 5, exam_relevance: 4, status: 'published', version: 1, tags: ['心包膜', '積液', '犬'], encyclopedia_link: null, cross_specialty_notes: '與腫瘤科、急診科相關', created_at: now, updated_at: now },
  { id: 'CARDIO-L3-005', specialty: 'CARDIO', title: '犬心絲蟲症', title_en: 'Heartworm Disease', layer: 3, node_type: 'disease', difficulty: 3, estimated_minutes: 25, clinical_relevance: 5, exam_relevance: 5, status: 'published', version: 1, tags: ['心絲蟲', '寄生蟲', '台灣'], encyclopedia_link: null, cross_specialty_notes: '與內科、影像科相關', created_at: now, updated_at: now },

  // Layer 4: 診斷方法
  { id: 'CARDIO-L4-001', specialty: 'CARDIO', title: '心臟聽診', title_en: 'Cardiac Auscultation', layer: 4, node_type: 'diagnostic', difficulty: 3, estimated_minutes: 20, clinical_relevance: 5, exam_relevance: 5, status: 'published', version: 1, tags: ['聽診', '理學檢查'], encyclopedia_link: null, cross_specialty_notes: null, created_at: now, updated_at: now },
