...
| Rabacfosadine 在第一線 vs 救援的定位 | RCT 證實有效（ORR 73.2%）；與 doxorubicin 交替可作初治，但與完整 CHOP 的頭對頭長期數據仍有限 | Level II |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Garrett LD et al. Evaluation of a 6-month chemotherapy protocol with no maintenance therapy for dogs with lymphoma. J Vet Intern Med. 2002;16(6):704-709.<0704:eoacpw>2.3.co;2', relevance: '犬淋巴瘤 CHOP 方案臨床研究' },
  ],
  is_current: true,
  created_at: now,
};
...
| Tigilanol tiglate 相對手術的定位 | 對不可切除/拒絕手術或高手術風險部位有價值；與廣切的長期頭對頭數據仍有限 | Level II |`,
  ...
  references: [
    { type: 'journal', citation: 'Kiupel M et al. Proposal of a 2-tier histologic grading system for canine cutaneous mast cell tumors to more accurately predict biological behavior. Vet Pathol. 2011;48(1):147-155. doi:10.1177/0300985810386469', relevance: 'Kiupel 二級分級系統原始文獻' },
    ...
    { type: 'journal', citation: 'London CA et al. Multi-center, placebo-controlled, double-blind, randomized study of oral toceranib phosphate (SU11654) for the treatment of dogs with recurrent mast cell tumor. Clin Cancer Res. 2009;15(11):3856-3865. doi:10.1158/1078-0432.ccr-08-1860', relevance: 'Toceranib 治療 MCT 的臨床試驗（基礎）' },
    { type: 'guideline', citation: 'VCOG，Veterinary Cooperative Oncology Group. Common Terminology Criteria for Adverse Events (VCOG-CTCAE) v2. Vet Comp Oncol. 2016;14(4):417-446. doi:10.1111/vco.283', relevance: 'MCT 化療副作用分級標準' },
  ],
  is_current: true,
  created_at: now,
};
...
| 安樂死時機的客觀標準，QoL 量表的信度和效度 | HHHHHMM 等量表被廣泛使用但缺乏正式驗證研究 | Level IV |`,
  ...
  references: [
    ...
    { type: 'guideline', citation: 'VCOG，Veterinary Cooperative Oncology Group. Common Terminology Criteria for Adverse Events (VCOG-CTCAE) v2. Vet Comp Oncol. 2016;14(4):417-446. doi:10.1111/vco.283', relevance: '化療副作用分級標準（毒性分級）' },
    ...
    { type: 'journal', citation: 'Paoloni M, Khanna C. Translation of new cancer treatments from pet dogs to humans. Nat Rev Cancer. 2008;8(2):147-156. doi:10.1038/nrc2273', relevance: '比較腫瘤學概念與價值（奠基文獻）' },
...
| 犬腫瘤的表觀遺傳學治療潛力 | DNA 甲基化抑制劑和 HDAC 抑制劑在犬腫瘤中的效果尚未臨床驗證 | Level IV |`,
  ...
  references: [
    ...
    { type: 'guideline', citation: 'AAHA Oncology Guidelines for Dogs and Cats. J Am Anim Hosp Assoc. 2016;52(4):181-204. doi:10.5326/jaaha-ms-6570', relevance: 'AAHA 腫瘤科指引，腫瘤生物學基本概念' },
  ],
  is_current: true,
  created_at: now,
};
...
| TIL（腫瘤浸潤淋巴球）密度作為犬腫瘤預後指標的標準化 | 高 CD8+ TIL 通常預後較好，但犬腫瘤 TIL 評估方法未統一 | Level III |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Maekawa N et al. A canine chimeric monoclonal antibody targeting PD-L1 and its clinical efficacy in canine oral malignant melanoma or undifferentiated sarcoma. Sci Rep. 2017;7(1):8951. doi:10.1038/s41598-017-09444-2', relevance: '犬 PD-L1 抗體初步研究' },
    { type: 'guideline', citation: 'VCOG，Veterinary Cooperative Oncology Group. Common Terminology Criteria for Adverse Events (VCOG-CTCAE) v2. Vet Comp Oncol. 2016;14(4):417-446. doi:10.1111/vco.283', relevance: '免疫治療相關副作用評估標準' },
  ],
  is_current: true,
  created_at: now,
};
...
| 表觀遺傳學（DNA 甲基化）作為犬腫瘤早期診斷工具 | 人醫已有多癌種甲基化篩檢產品（Galleri），犬研究起步中 | Level IV |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Mochizuki H et al. BRAF mutations in canine cancers. PLoS One. 2015;10(6):e0129534. doi:10.1371/journal.pone.0129534', relevance: 'BRAF 突變在犬腫瘤的發現與臨床應用' },
    { type: 'journal', citation: 'Schiffman JD, Breen M. Comparative oncology: what dogs and other species can teach us about humans with cancer. Philos Trans R Soc Lond B Biol Sci. 2015;370(1673):20140231. doi:10.1098/rstb.2014.0231', relevance: '犬腫瘤基因組學比較研究' },
    { type: 'guideline', citation: 'AAHA Oncology Guidelines for Dogs and Cats. J Am Anim Hosp Assoc. 2016;52(4):181-204. doi:10.5326/jaaha-ms-6570', relevance: 'AAHA 腫瘤科指引，分子檢測與標靶治療概述' },
  ],
  is_current: true,
  created_at: now,
};
...
| 轉移前微環境／外泌體 | 原發腫瘤經外泌體與骨髓來源細胞「預處理」遠端器官的機制研究持續累積，但犬臨床轉譯仍處早期。 | 阻斷 pre-metastatic niche 為未來輔助治療方向；目前屬研究性。 | Fidler 2003 |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Paget S. "The distribution of secondary growths in cancer of the breast." Lancet. 1889;133(3421):571-573. doi:10.1016/s0140-6736(00)49915-0', relevance: 'Seed-and-soil 理論經典文獻（1889；以 biblio 解析）' },
...
| 化療劑量強度（dose intensity）vs 劑量密度（dose density）對犬腫瘤抗藥性產生的影響 | Norton-Simon 和 Goldie-Coldman 假說支持不同策略，犬腫瘤前瞻性比較數據缺乏 | Level IV |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Zandvliet M, Teske E. Mechanisms of drug resistance in veterinary oncology: a review with an emphasis on canine lymphoma. Vet Sci. 2015;2(3):150-184. doi:10.3390/vetsci2030150', relevance: '獸醫腫瘤抗藥性全面回顧' },
    { type: 'journal', citation: 'Price GS et al. Multidrug resistance gene (MDR1) expression and effect on treatment response in canine lymphoma. J Vet Intern Med. 1991;5(2):96. doi:10.1182/blood.v78.3.586.bloodjournal783586', relevance: 'P-gp 在犬淋巴瘤抗藥性的研究' },
    { type: 'guideline', citation: 'VCOG，Veterinary Cooperative Oncology Group. Common Terminology Criteria for Adverse Events (VCOG-CTCAE) v2. Vet Comp Oncol. 2016;14(4):417-446. doi:10.1111/vco.283', relevance: '化療抗藥後毒性分級與劑量調整指引' },
  ],
  is_current: true,
  created_at: now,
};
...
| 獸醫放療中反覆全身麻醉（12-20 次）的累積風險 | 每次麻醉風險低（< 0.1%），但多次累積風險、飼主時間與經濟負擔為主要障礙 | Level III |`,
  ...
  references: [
    ...
    { type: 'guideline', citation: 'AAHA Oncology Guidelines for Dogs and Cats. J Am Anim Hosp Assoc. 2016;52(4):181-204. doi:10.5326/jaaha-ms-6570', relevance: 'AAHA 腫瘤科指引，放射治療角色與轉介建議' },
  ],
  is_current: true,
  created_at: now,
};
...
| 節拍式化療的最佳持續時間，持續到疾病進展 vs 固定療程 | 多數方案為持續給藥直到進展，但長期 Cyclophosphamide 的累積出血性膀胱炎風險需權衡 | Level III |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Leach TN et al. Prospective trial of metronomic chlorambucil chemotherapy in dogs with naturally occurring cancer. Vet Comp Oncol. 2012;10(2):102-112. doi:10.1111/j.1476-5829.2011.00280.x', relevance: '節拍式 Chlorambucil 前瞻性試驗' },
    { type: 'journal', citation: 'Burton JH et al. Low-dose cyclophosphamide selectively decreases regulatory T cells and inhibits angiogenesis in dogs with soft tissue sarcoma. J Vet Intern Med. 2011;25(4):920-926. doi:10.1111/j.1939-1676.2011.0753.x', relevance: '犬低劑量 Cyclophosphamide 的免疫調節和抗血管新生機轉' },
    { type: 'guideline', citation: 'VCOG，Veterinary Cooperative Oncology Group. Common Terminology Criteria for Adverse Events (VCOG-CTCAE) v2. Vet Comp Oncol. 2016;14(4):417-446. doi:10.1111/vco.283', relevance: '節拍式化療副作用分級與監測標準' },
  ],
  is_current: true,
  created_at: now,
};
...
| 雙特異性抗體（BiTE） | 犬腫瘤的 T 細胞導向免疫療法 | 概念驗證階段 |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Maekawa N et al. A canine chimeric monoclonal antibody targeting PD-L1 and its clinical efficacy in canine oral malignant melanoma or undifferentiated sarcoma. Sci Rep. 2017;7(1):8951. doi:10.1038/s41598-017-09444-2', relevance: '犬 PD-L1 抗體臨床效果' },
    { type: 'journal', citation: 'Hanahan D, Weinberg RA. Hallmarks of cancer: the next generation. Cell. 2011;144(5):646-674. doi:10.1016/j.cell.2011.02.013', relevance: '癌症標誌，腫瘤微環境作為新興標誌' },
    { type: 'guideline', citation: 'Bergman PJ et al. Development of a xenogeneic DNA vaccine program for canine malignant melanoma at the Animal Medical Center. Vaccine. 2006;24(21):4582-4585. doi:10.1016/j.vaccine.2005.08.027', relevance: '犬黑色素瘤 DNA 疫苗，TME 免疫調節策略' },
  ],
  is_current: true,
  created_at: now,
};
...
[圖片:犬鼻腔 CT 影像，Modified Adams 各分期示意]`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Adams WM et al. Radiotherapy of malignant nasal tumors in 67 dogs. J Am Vet Med Assoc. 1987;191(3):311-315. doi:10.2460/javma.1987.191.03.311', relevance: '犬鼻腔腫瘤放療經典文獻，Adams 分期原始資料' },
    { type: 'journal', citation: 'Theon AP et al. Megavoltage irradiation of neoplasms of the nasal and paranasal cavities in 77 dogs. J Am Vet Med Assoc. 1993;202(9):1469-1475. doi:10.2460/javma.1993.202.09.1469', relevance: '犬鼻腔腫瘤放療預後因子分析' },
...
[圖片:犬甲狀腺癌 freely movable vs fixed 觸診示意圖]`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Theon AP et al. Prognostic factors and patterns of treatment failure in dogs with unresectable differentiated thyroid carcinomas treated with megavoltage irradiation. J Am Vet Med Assoc. 2000;216(11):1775-1779. doi:10.2460/javma.2000.216.1775', relevance: '犬甲狀腺癌放療預後因子' },
    { type: 'journal', citation: 'Worth AJ et al. Thyroidectomy as a treatment for canine thyroid carcinoma: 12 cases. N Z Vet J. 2005;53(4):228-233. doi:10.1111/j.1751-0813.2005.tb11650.x', relevance: '⚠️ 待 DVM 查證：N Z Vet J 2005 查無此篇；Worth 2005 真實甲狀腺癌文為 Aust Vet J 2005;83(4):208-214（放射碘 131I，非甲狀腺切除，主題/期刊被混植）；疑捏造/誤引，DVM 確認前不宜視為已驗證' },
...
> 臨床內容與所有劑量需獸醫師依現行指引與仿單核對。`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Wobeser BK et al. Diagnoses and clinical outcomes associated with surgically amputated canine digits submitted to multiple veterinary diagnostic laboratories. Vet Pathol. 2007;44(3):355-361. doi:10.1354/vp.44-3-355', relevance: '犬趾部腫瘤（甲床 SCC）截趾預後' },
...
| 多靶點組合（TKI + 免疫治療） | 協同抗腫瘤效果 | 人醫已成為多種癌症標準治療，獸醫探索階段 |`,
  ...
  references: [
    { type: 'journal', citation: 'London CA et al. Multi-center, placebo-controlled, double-blind, randomized study of oral toceranib phosphate (Palladia, SU11654), a receptor tyrosine kinase inhibitor, for the treatment of dogs with recurrent (either local or distant) mast cell tumor following surgical excision. Clin Cancer Res. 2009;15(11):3856-3865. doi:10.1158/1078-0432.ccr-08-1860', relevance: 'Toceranib FDA 核准臨床試驗（MCT）' },
    { type: 'journal', citation: 'Hahn KA et al. Masitinib is safe and effective for the treatment of canine mast cell tumors. J Vet Intern Med. 2008;22(6):1301-1309. doi:10.1111/j.1939-1676.2008.0190.x', relevance: 'Masitinib 犬 MCT 臨床試驗' },
...
[圖片:HCC 形態學分型與預後比較圖，massive vs nodular vs diffuse]`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Liptak JM, Dernell WS, Monnet E, et al. Massive hepatocellular carcinoma in dogs: 48 cases (1992-2002). JAVMA. 2004;225(8):1225-1230. doi:10.2460/javma.2004.225.1225', relevance: '犬 massive HCC 最大型回顧研究，MST > 1460 天' },
    { type: 'journal', citation: 'Patnaik AK, Hurvitz AI, Lieberman PH. Canine hepatic neoplasms: a clinicopathologic study. Vet Pathol. 1980;17(5):553-564. doi:10.1177/030098588001700504', relevance: '犬肝臟腫瘤分類與臨床病理經典研究' },
