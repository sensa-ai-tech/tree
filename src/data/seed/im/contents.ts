...
| 最佳蛋白攝取 | 適度限制而非嚴格限制 | Level II-III | 貓最適蛋白需求仍有爭議 |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Polzin DJ. "Chronic Kidney Disease in Small Animals." Vet Clin North Am Small Anim Pract. 2011;41(1):15-30. doi:10.1016/j.cvsm.2010.09.004', relevance: 'CKD 管理綜合回顧' },
    { type: 'guideline', citation: 'Lees GE et al. "Assessment and Management of Proteinuria in Dogs and Cats: 2004 ACVIM Forum Consensus Statement." J Vet Intern Med. 2005;19(3):377-385. doi:10.1111/j.1939-1676.2005.tb02713.x', relevance: '蛋白尿評估與管理共識' },
...
> 臨床內容與所有劑量需獸醫師依現行指引與仿單核對。`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Lathan P, Thompson AL. Management of hypoadrenocorticism (Addison\'s disease) in dogs. Vet Med (Auckl). 2018;9:1-10. doi:10.2147/vmrr.s125617', relevance: 'Addison\'s 長期管理策略' },
...
| I-131 後醫源性甲狀腺低下要不要補 levothyroxine | 甲狀腺低下且腎正常者補充可延壽；已有 CKD 者無益 | Level III | 需 RCT 確認 |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Williams TL et al. "Survival and the development of azotemia after treatment of hyperthyroid cats." J Vet Intern Med. 2010;24(4):863-869. doi:10.1111/j.1939-1676.2010.0550.x', relevance: '甲亢治療後 CKD 揭露與存活分析（基礎研究）' },
  ],
  is_current: true,
  created_at: now,
};
...
> ⚠️ **2024 新證據（待 DVM 審閱）**：Agnoli 等人發表於 JVIM 的隨機對照試驗（DOI 10.1111/jvim.17122）顯示，於犬 IMHA 一線治療「類固醇 + mycophenolate mofetil」雙藥組合，相較單用類固醇並未提高治療反應率，且 MMF 組存活率較低。臨床意義：不要把「一線就上雙藥」當預設；第二免疫抑制劑保留給類固醇 48–72 小時反應不佳、或無法耐受高劑量類固醇的個案，且加藥後須密切監控。本段落為文獻更新，臨床採用前請由主治獸醫師依個案判斷。`,
  ...
  references: [
    { type: 'guideline', citation: 'Garden OA et al. "ACVIM consensus statement on the diagnosis of immune-mediated hemolytic anemia in dogs and cats." J Vet Intern Med. 2019;33(2):313-334. doi:10.1111/jvim.15441', relevance: 'IMHA 診斷 ACVIM 共識（診斷分層、自凝集、Coombs）' },
    { type: 'guideline', citation: 'Swann JW et al. "ACVIM consensus statement on the treatment of immune-mediated hemolytic anemia in dogs." J Vet Intern Med. 2019;33(3):1141-1172. doi:10.1111/jvim.15463', relevance: 'IMHA 治療 ACVIM 共識（免疫抑制階梯 + 全面抗血栓）' },
    ...
    { type: 'journal', citation: 'Weinkle TK et al. "Evaluation of prognostic factors, survival rates, and treatment protocols for immune-mediated hemolytic anemia in dogs: 151 cases (1993-2002)." J Am Vet Med Assoc. 2005;226(11):1869-1880. doi:10.2460/javma.2005.226.1869', relevance: 'IMHA 預後因子與存活率分析' },
...
| 貓 DM 緩解後的最佳追蹤 | 定期 Fructosamine/血糖 | Level III | 緩解後復發預測因子？ |`,
  ...
  references: [
    { type: 'guideline', citation: 'Behrend E et al. "2018 AAHA Diabetes Management Guidelines for Dogs and Cats." J Am Anim Hosp Assoc. 2018;54(1):1-21（2022 更新納入 CGM、ProZinc/PZI 犬每日一次）. doi:10.5326/jaaha-ms-6822', relevance: 'AAHA 糖尿病管理指引' },
    ...
    { type: 'journal', citation: 'Rothlin-Zachrisson N et al. "Survival, remission, and quality of life in diabetic cats." J Vet Intern Med. 2023;37(1):58-69. doi:10.1111/jvim.16625', relevance: '貓 DM 緩解率與飲食關聯（2026-06 新增）' },
    ...
    { type: 'journal', citation: 'Roomp K, Rand J. "Intensive blood glucose control is safe and effective in diabetic cats using home monitoring and treatment with glargine." J Feline Med Surg. 2009;11(8):668-682. doi:10.1016/j.jfms.2009.04.010', relevance: '貓 Glargine 治療與緩解策略' },
    { type: 'journal', citation: 'O\'Brien MA. "Diabetic emergencies in small animals." Vet Clin North Am Small Anim Pract. 2010;40(2):317-333. doi:10.1016/j.cvsm.2009.10.003', relevance: 'DKA 急救管理' },
  ],
  is_current: true,
  created_at: now,
};
...
| 台灣流行病學數據庫 | 缺乏系統性全國數據 |—| 建立獸醫全國疾病登錄系統 |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Cockcroft PD, Holmes MA. "Evidence-based veterinary medicine 1. Why is it important and what skills are needed?" In Practice. 2004;26(1):28-33. doi:10.1136/inpract.26.1.28', relevance: '循證獸醫學概論（EBM 為何重要、需要哪些技能）' },
...
| 犬貓免疫表型分析 | 流式細胞儀限於研究機構 | Level III | 商品化犬貓免疫表型 panel |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Garden OA et al. "ACVIM consensus statement on the diagnosis of immune-mediated hemolytic anemia in dogs and cats." J Vet Intern Med. 2019;33(2):313-334. doi:10.1111/jvim.15441', relevance: '免疫介導性溶血的免疫機轉' },
    { type: 'guideline', citation: 'Garden OA, Kidd L, Mexas AM, et al. "ACVIM consensus statement on the diagnosis of immune-mediated hemolytic anemia in dogs and cats." J Vet Intern Med. 2019;33(2):313-334. doi:10.1111/jvim.15441', relevance: 'IMHA 診斷共識' },
  ],
  is_current: true,
  created_at: now,
};
...
| 膽汁酸代謝與 CE 的關係 | C. hiranonis 減少→初級膽汁酸↑ | Level II | 膽汁酸調控介入策略 |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Suchodolski JS. "Intestinal microbiota of dogs and cats: a bigger world than we thought." Vet Clin North Am Small Anim Pract. 2011;41(2):261-272. doi:10.1016/j.cvsm.2010.12.006', relevance: '犬貓腸道微生物群回顧' },
    { type: 'guideline', citation: 'Washabau RJ, Day MJ, Willard MD, et al. "Endoscopic, biopsy, and histopathologic guidelines for the evaluation of gastrointestinal inflammation in companion animals." J Vet Intern Med. 2010;24(1):10-26. doi:10.1111/j.1939-1676.2009.0443.x', relevance: 'GI 炎症評估指引' },
  ],
  is_current: true,
  created_at: now,
...
| 非典型愛迪生的病程預測 | 部分進展為典型型 | Level IV | 長期追蹤研究 |`,
  ...
  references: [
    { type: 'guideline', citation: 'Behrend E et al. "2018 AAHA Diabetes Management Guidelines for Dogs and Cats." J Am Anim Hosp Assoc. 2018;54(1):1-21. doi:10.5326/jaaha-ms-6822', relevance: '犬貓糖尿病管理共識' },
    ...
    { type: 'journal', citation: 'Peterson ME. "Hyperthyroidism in cats: what\'s causing this epidemic of thyroid disease and can we prevent it?" J Feline Med Surg. 2012;14(11):804-818. doi:10.1177/1098612x12464462', relevance: '貓甲亢流行病學與病因' },
...
| 食物不耐受 vs 食物過敏 | 鑑別困難 | Level III | 更好的體外測試方法 |`,
  ...
  drug_api_links: [],
  references: [
    { type: 'journal', citation: 'Suchodolski JS. "Diagnosis and interpretation of intestinal dysbiosis in dogs and cats." Vet J. 2016;215:30-37. doi:10.1016/j.tvjl.2016.04.011', relevance: '腸道微生物群失調診斷與判讀' },
    { type: 'journal', citation: 'Dandrieux JRS. "Inflammatory bowel disease versus chronic enteropathy in dogs." J Small Anim Pract. 2016;57(11):589-599. doi:10.1111/jsap.12588', relevance: '腸道發炎機轉與 CE 分類' },
...
| 貓肝再生能力差的機轉 | 觀察到但機轉不明 | Level IV | 貓肝細胞增殖調控研究 |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Center SA. "Feline hepatic lipidosis." Vet Clin North Am Small Anim Pract. 2005;35(1):225-269. doi:10.1016/j.cvsm.2004.10.002', relevance: '貓 FHL 代謝機轉' },
    { type: 'journal', citation: 'Hoffmann G. "Copper-associated liver diseases." Vet Clin North Am Small Anim Pract. 2009;39(3):489-511. doi:10.1016/j.cvsm.2009.02.001', relevance: '犬銅蓄積性肝病機轉' },
    { type: 'guideline', citation: 'Webster CRL, Center SA, Cullen JM, et al. "ACVIM consensus statement on the diagnosis and treatment of chronic hepatitis in dogs." J Vet Intern Med. 2019;33(3):1173-1200. doi:10.1111/jvim.15467', relevance: '犬慢性肝炎診治共識' },
  ],
  is_current: true,
  created_at: now,
};
...
| 貓正常 AG 範圍 | 13-27（文獻不一） | Level III | 大規模正常貓 AG 數據 |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Hopper K, Epstein SE. "Incidence, nature, and etiology of metabolic acidosis in dogs and cats." J Vet Intern Med. 2012;26(5):1107-1114. doi:10.1111/j.1939-1676.2012.00983.x', relevance: '犬貓代謝性酸中毒流行病學' },
...
| 飲食試驗前是否需先做內視鏡 | 飲食試驗優先，除非嚴重 | Level II | 最佳診斷順序研究 |`,
  ...
  drug_api_links: [],
  references: [
    { type: 'guideline', citation: 'Washabau RJ et al. "Endoscopic, Biopsy, and Histopathologic Guidelines for the Evaluation of Gastrointestinal Inflammation in Companion Animals." J Vet Intern Med. 2010;24(1):10-26. doi:10.1111/j.1939-1676.2009.0443.x', relevance: 'WSAVA 消化道內視鏡與組織學指引' },
    { type: 'textbook', citation: 'Tams TR, Rawlings CA. Small Animal Endoscopy, 3rd ed. Elsevier, 2011.', relevance: '小動物內視鏡操作教科書' },
    { type: 'journal', citation: 'Kiupel M et al. "Proposal of a 2-tier histologic grading system for canine cutaneous mast cell tumors to more accurately predict biological behavior." Vet Pathol. 2011;48(1):147-155. doi:10.1177/0300985810386469', relevance: '腫瘤組織學分級標準化參考' },
  ],
  is_current: true,
  created_at: now,
};
...
| Propylthiouracil | 免疫介導 | 貓嚴重血球減少（已少用） | 高 |`,
  ...
  references: [
    { type: 'guideline', citation: 'Garden OA et al. "ACVIM consensus statement on the diagnosis of immune-mediated hemolytic anemia in dogs and cats." J Vet Intern Med. 2019;33(2):313-334. doi:10.1111/jvim.15441', relevance: 'IMHA 免疫機轉與診斷共識' },
    ...
    { type: 'journal', citation: 'Trepanier LA. "Idiosyncratic toxicity associated with potentiated sulfonamides in the dog." J Vet Pharmacol Ther. 2004;27(3):129-138. doi:10.1111/j.1365-2885.2004.00576.x', relevance: '藥物誘發免疫反應機轉' },
...
> 臨床內容與所有劑量需獸醫師依現行指引與仿單核對。`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Hartmann K. "Clinical aspects of feline retroviruses: A review." Viruses. 2012;4(11):2684-2710. doi:10.3390/v4112684', relevance: 'FeLV/FIV 臨床綜述' },
...
| 呼吸頻率 | 15-30/min | 20-40/min |—|`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Rozanski E. "Canine chronic bronchitis." Vet Clin North Am Small Anim Pract. 2020;50(2):393-404. doi:10.1016/j.cvsm.2019.10.003', relevance: '犬慢性支氣管疾病與呼吸生理' },
    { type: 'guideline', citation: 'Sumner C, Rozanski E. "Management of respiratory emergencies in small animals." Vet Clin North Am Small Anim Pract. 2013;43(4):799-815. doi:10.1016/j.cvsm.2013.03.005', relevance: '呼吸急診中的生理學應用' },
  ],
  is_current: true,
  created_at: now,
};
...
| 慢性發炎 | 纖毛細胞被杯狀細胞取代 | 清除功能永久下降 |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Reinero CR. "Advances in the understanding of pathogenesis, and diagnostics and therapeutics for feline allergic asthma." Vet J. 2011;190(1):28-33. doi:10.1016/j.tvjl.2010.09.022', relevance: '貓哮喘免疫病理機轉' },
    { type: 'journal', citation: 'Trzil JE. "Feline Asthma: Diagnostic and Treatment Update." Vet Clin North Am Small Anim Pract. 2020;50(2):375-391. doi:10.1016/j.cvsm.2019.10.002', relevance: '貓哮喘發炎與重塑最新知識' },
...
關鍵: 早期外科介入明顯優於等待破裂後緊急手術。`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Aguirre AL, Center SA, Randolph JF, et al. "Gallbladder disease in Shetland Sheepdogs: 38 cases (1995-2005)." J Am Vet Med Assoc. 2007;231(1):79-88. doi:10.2460/javma.231.1.79', relevance: 'Shetland Sheepdog 膽囊黏液囊腫品種傾向' },
    ...
    { type: 'guideline', citation: 'Jaffey JA, Graham A, VanEerde E, et al. "Gallbladder mucocele: variables associated with outcome and the utility of ultrasonography to identify gallbladder rupture in 219 dogs." J Vet Intern Med. 2018;32(1):195-200. doi:10.1016/j.asams.2019.01.005', relevance: '超音波診斷與預後因子分析' },
  ],
  is_current: true,
  created_at: now,
};
...
const contentMDR1Toxicity: NodeContent = {
  ...
  references: [
    ...
    { type: 'journal', citation: 'Bates N, Chatterton J, Robbins C, et al. Lipid infusion in the management of poisoning: a report of 6 canine cases. Vet Rec. 2013;172(13):339. doi:10.1136/vr.101036', relevance: '英國毒物中心 ILE 病例系列，確立 8 mL/kg/day 上限' },
