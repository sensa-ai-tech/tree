...
export const IM_PATHS: LearningPath[] = [
  ...
  },
  {
    ...
    title: '嘆吐的跨科鑑別診斷路徑',
    description: '以嘆吐為主訴，整合內科、外科、急診、臨床病理的跨科鑑別診斷流程。涵蓋胰臟炎、腸道異物、DKA、Addison 等常見病因。',
    specialty: 'IM',
    target_audience: '一般臨床獸醫、實習獸醫',
    estimated_hours: 6,
    path_nodes: [
      { node_id: 'IM-L1-003', is_required: true, phase: '基礎概念', learning_note: '消化系統生理——嘆吐機轉的基礎' },
      { node_id: 'IM-L3-008', is_required: true, phase: '內科病因', learning_note: '胰臟炎——嘆吐最常見內科病因' },
      { node_id: 'IM-L3-011', is_required: false, phase: '內科病因', learning_note: '選修：Addison 危象也可以嘆吐表現' },
      { node_id: 'SURG-L3-003', is_required: true, phase: '外科病因', learning_note: '腸道異物——外科急診嘆吐' },
      { node_id: 'ECC-L3-002', is_required: true, phase: '急診病因', learning_note: 'DKA——嘆吐合併代謝急診' },
      { node_id: 'CPATH-L4-002', is_required: true, phase: '診斷工具', learning_note: '生化檢查——嘆吐鑑別的關鍵' },
    ],
    milestones: [
      { id: 'MS-CROSS-VOM-01', title: '嘆吐病因掌握', description: '完成內科、外科、急診嘆吐病因', required_nodes: ['IM-L3-008', 'SURG-L3-003', 'ECC-L3-002'], checkpoint_type: 'quiz', pass_criteria: '測驗正確率 >= 80%' },
      { id: 'MS-CROSS-VOM-02', title: '路徑完成', description: '通過嘆吐鑑別診斷病例挑戰', required_nodes: ['CPATH-L4-002'], checkpoint_type: 'case', pass_criteria: '病例挑戰得分 >= 70%' },
    ],
  ...
  },
  {
    ...
    title: '呼吸困難的跨科鑑別診斷路徑',
    description: '以呼吸困難為主訴，整合心臟科、內科、急診的跨科鑑別。涵蓋心衰竭、胸水、肺炎、氣喊等常見病因。',
    specialty: 'IM',
    target_audience: '一般臨床獸醫、實習獸醫',
    estimated_hours: 6,
    path_nodes: [
  ...
  },
  {
    ...
    title: '貧血的跨科鑑別診斷路徑',
    description: '以貧血為主訴，整合內科、急診、臨床病理、腫砤科的跨科鑑別。涵蓋 IMHA、艀蟲感染、出血性貧血與輸血醫學。',
    specialty: 'IM',
    target_audience: '一般臨床獸醫、住院獸醫',
    estimated_hours: 8,
    path_nodes: [
      ...
      { node_id: 'IM-L3-010', is_required: true, phase: '內科病因', learning_note: '艀蟲感染——台灣常見貧血病因' },
    ...
    milestones: [
      { id: 'MS-CROSS-ANE-01', title: '貧血病因掌握', description: '完成 CBC 判讀、IMHA 與艀蟲感染', required_nodes: ['CPATH-L4-001', 'IM-L3-005', 'IM-L3-010'], checkpoint_type: 'quiz', pass_criteria: '測驗正確率 >= 80%' },
  ...
  },
  {
    ...
    title: '虛弱/塔倒的跨科鑑別診斷路徑',
    description: '以虛弱或塔倒為主訴，整合心臟科、神經科、內科、急診的跨科鑑別。涵蓋暈厥、癲癃、低血糖、Addison 等常見病因。',
    specialty: 'IM',
    target_audience: '一般臨床獸醫、實習獸醫',
    estimated_hours: 6,
    path_nodes: [
      { node_id: 'CARDIO-L2-003', is_required: true, phase: '心臟病因', learning_note: '心律不整機轉——暈厥的重要病因' },
      { node_id: 'NEURO-L2-001', is_required: true, phase: '神經病因', learning_note: '癲癃機轉——與暈厥的鑑別' },
      { node_id: 'IM-L3-011', is_required: true, phase: '內科病因', learning_note: 'Addison——虛弱的重要內科病因' },
      { node_id: 'IM-L3-006', is_required: true, phase: '內科病因', learning_note: '糖尿病——低血糖可致虛弱/塔倒' },
    ...
    milestones: [
      ...
      { id: 'MS-CROSS-WK-02', title: '路徑完成', description: '通過虛弱/塔倒鑑別診斷病例挑戰', required_nodes: ['NEURO-L4-001', 'CPATH-L4-002'], checkpoint_type: 'case', pass_criteria: '病例挑戰得分 >= 70%' },
    ],
    has_certificate: false,
    status: 'published',
  },
  {
    ...
    title: '皮膚腫塊的跨科鑑別診斷路徑',
    description: '以皮膚腫塊為主訴，整合皮膚科、腫砤科、臨床病理、外科的跨科評估與決策流程。涵蓋 MCT、乳腔腫砤、FISS 等常見腫塊。',
    specialty: 'IM',
    target_audience: '一般臨床獸醫、住院獸醫',
    estimated_hours: 6,
    path_nodes: [
      { node_id: 'DERM-L4-003', is_required: true, phase: '基礎診斷', learning_note: '皮膚細胞學——腫塊評估的第一步' },
      { node_id: 'ONCO-L4-001', is_required: true, phase: '腫砤診斷', learning_note: '腫砤細胞學——FNA 與細胞學判讀' },
      { node_id: 'ONCO-L3-002', is_required: true, phase: '常見腫塊', learning_note: 'MCT——犬最常見皮膚腫砤' },
      { node_id: 'ONCO-L3-006', is_required: true, phase: '常見腫塊', learning_note: '乳腔腫砤——犬貓常見' },
      ...
      { node_id: 'ONCO-L5-002', is_required: true, phase: '治療決策', learning_note: '腫砤外科原則——切緣與手術計畫' },
    ],
    milestones: [
      { id: 'MS-CROSS-SM-01', title: '腫塊評估與鑑別', description: '完成細胞學、MCT 與乳腔腫砤', required_nodes: ['DERM-L4-003', 'ONCO-L4-001', 'ONCO-L3-002', 'ONCO-L3-006'], checkpoint_type: 'quiz', pass_criteria: '測驗正確率 >= 80%' },
