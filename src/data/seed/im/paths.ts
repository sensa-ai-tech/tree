...
export const IM_PATHS: LearningPath[] = [
  {
    ...
    path_nodes: [
      ...
      { node_id: 'IM-L1-004', is_required: true, phase: '基礎概念', learning_note: '內分泌系統的基礎生理，HPA 軸與甲狀腺軸' },
      ...
      { node_id: 'IM-L3-011', is_required: false, phase: '臨床疾病', learning_note: '選修：犬腎上腺皮質機能低下（Addison\'s）——低鈉高鉀、Addisonian crisis 為急診鑑別' },
    ...
    milestones: [
      {
        ...
        required_nodes: ['IM-L0-001', 'IM-L1-004', 'IM-L2-002'],
  ...
  },
  {
    ...
    path_nodes: [
      { node_id: 'IM-L0-001', is_required: true, phase: '基礎概念', learning_note: '起點：了解內科學全貌' },
      { node_id: 'IM-L1-001', is_required: true, phase: '基礎概念', learning_note: '腎臟生理與尿液形成機轉' },
      ...
      { node_id: 'IM-L3-013', is_required: false, phase: '進階關聯', learning_note: '選修：急性腎損傷（AKI）——與 CKD 的鑑別及急性處置' },
      { node_id: 'IM-L3-014', is_required: false, phase: '進階關聯', learning_note: '選修：蛋白質流失性腎病（PLN）——腎絲球疾病與蛋白尿管理' },
    ],
    milestones: [
      {
        id: 'MS-IM-RENAL-01',
        ...
        required_nodes: ['IM-L0-001', 'IM-L1-001', 'IM-L2-001'],
        checkpoint_type: 'quiz',
        pass_criteria: '測驗正確率 >= 70%',
      },
      {
  ...
  },
  {
    ...
    estimated_hours: 6,
    path_nodes: [
      { node_id: 'CARDIO-L1-003', is_required: true, phase: '基礎概念', learning_note: '心臟血流動力學——呼吸困難與肺水腫機轉基礎' },
    ...
    milestones: [
      { id: 'MS-CROSS-DYS-01', title: '呼吸困難病因掌握', description: '完成心臟科、急診呼吸困難病因', required_nodes: ['CARDIO-L3-001', 'CARDIO-L3-003', 'CARDIO-L1-003'], checkpoint_type: 'quiz', pass_criteria: '測驗正確率 >= 80%' },
  ...
  },
  {
    ...
    title: '皮膚腫塊的跨科鑑別診斷路徑',
    description: '以皮膚腫塊為主訴，整合皮膚科、腫瘤科、臨床病理、外科的跨科評估與決策流程。涵蓋 MCT、乳腺腫瘤、FISS 等常見腫塊。',
    specialty: 'IM',
    target_audience: '一般臨床獸醫、住院獸醫',
    estimated_hours: 6,
    path_nodes: [
      ...
      { node_id: 'ONCO-L3-006', is_required: true, phase: '常見腫塊', learning_note: '乳腺腫瘤——犬貓常見' },
    ...
    milestones: [
      { id: 'MS-CROSS-SM-01', title: '腫塊評估與鑑別', description: '完成細胞學、MCT 與乳腺腫瘤', required_nodes: ['DERM-L4-003', 'ONCO-L4-001', 'ONCO-L3-002', 'ONCO-L3-006'], checkpoint_type: 'quiz', pass_criteria: '測驗正確率 >= 80%' },
  ...
  },
  {
    id: 'PATH-IM-IMMUNE',
    title: '免疫介導疾病診療路徑',
    description: '從免疫系統基礎到免疫介導疾病（IMHA、IMT）的診斷與免疫抑制治療策略。涵蓋超敏反應分類、自體免疫機轉、Evans syndrome 與免疫抑制藥物選擇。適合住院獸醫及急診獸醫。',
    specialty: 'IM',
    target_audience: '住院獸醫',
    estimated_hours: 8,
    path_nodes: [
      { node_id: 'IM-L0-001', is_required: true, phase: '基礎概念', learning_note: '起點：了解內科學全貌' },
      { node_id: 'IM-L2-003', is_required: true, phase: '基礎概念', learning_note: '發炎與免疫調節——免疫介導疾病的共通基礎' },
      { node_id: 'IM-L2-006', is_required: true, phase: '病理機轉', learning_note: '免疫介導疾病機轉——超敏反應分類與免疫耐受破壞' },
      { node_id: 'IM-L3-005', is_required: true, phase: '核心疾病', learning_note: 'IMHA——最常見的免疫介導血液疾病' },
      { node_id: 'IM-L3-015', is_required: true, phase: '核心疾病', learning_note: 'IMT——免疫介導血小板減少症與 Evans syndrome' },
      { node_id: 'IM-L5-003', is_required: true, phase: '治療管理', learning_note: '免疫抑制治療策略——藥物選擇、劑量調整與減藥原則' },
    ],
    milestones: [
      {
        id: 'MS-IM-IMMUNE-01',
        title: '免疫基礎過關',
        description: '完成免疫調節與免疫介導疾病機轉',
        required_nodes: ['IM-L0-001', 'IM-L2-003', 'IM-L2-006'],
        checkpoint_type: 'quiz',
        pass_criteria: '測驗正確率 >= 70%',
      },
      {
        id: 'MS-IM-IMMUNE-02',
        title: '免疫疾病掌握',
        description: '完成 IMHA 與 IMT 核心節點',
        required_nodes: ['IM-L3-005', 'IM-L3-015'],
        checkpoint_type: 'quiz',
        pass_criteria: '測驗正確率 >= 80%',
      },
      {
        id: 'MS-IM-IMMUNE-03',
        title: '路徑完成',
        description: '完成免疫抑制治療並通過免疫疾病病例挑戰',
        required_nodes: ['IM-L5-003'],
        checkpoint_type: 'case',
        pass_criteria: '病例挑戰得分 >= 70%',
      },
    ],
  ...
  },
  {
    id: 'PATH-IM-FELINE',
    title: '貓內科疾病專精路徑',
    description: '涵蓋貓特有或好發的內科疾病：FIP、FLUTD、膽管炎/三合症、甲狀腺機能亢進、肝臟脂肪變性。從貓的生理特殊性到各疾病的診斷與治療。適合有志於貓科醫學的住院獸醫與一般臨床獸醫。',
    specialty: 'IM',
    target_audience: '住院獸醫、一般臨床獸醫',
    estimated_hours: 10,
    path_nodes: [
      { node_id: 'IM-L0-001', is_required: true, phase: '基礎概念', learning_note: '起點：了解內科學全貌' },
      { node_id: 'IM-L2-006', is_required: true, phase: '病理機轉', learning_note: '免疫介導疾病機轉——FIP 的免疫病理基礎' },
      { node_id: 'IM-L2-004', is_required: true, phase: '病理機轉', learning_note: '肝膽病理機轉——膽管炎與肝脂質沉積的基礎' },
      { node_id: 'IM-L3-003', is_required: true, phase: '核心疾病', learning_note: '貓甲狀腺機能亢進——老年貓最常見的內分泌疾病' },
      { node_id: 'IM-L3-017', is_required: true, phase: '核心疾病', learning_note: 'FIP——從致命疾病到可治療的突破性進展' },
      { node_id: 'IM-L3-018', is_required: true, phase: '核心疾病', learning_note: 'FLUTD——貓下泌尿道疾病與環境管理' },
      { node_id: 'IM-L3-019', is_required: true, phase: '核心疾病', learning_note: '貓膽管炎與三合症——貓特有的肝膽疾病' },
      { node_id: 'IM-L3-009', is_required: true, phase: '核心疾病', learning_note: '貓肝臟脂肪變性——貓最常見的肝臟疾病' },
    ],
    milestones: [
      {
        id: 'MS-IM-FELINE-01',
        title: '貓科基礎過關',
        description: '完成貓相關的病理機轉基礎',
        required_nodes: ['IM-L0-001', 'IM-L2-006', 'IM-L2-004'],
        checkpoint_type: 'quiz',
        pass_criteria: '測驗正確率 >= 70%',
      },
      {
        id: 'MS-IM-FELINE-02',
        title: '貓科核心疾病掌握',
        description: '完成 FIP、FLUTD、膽管炎、甲亢、肝脂質沉積五大疾病',
        required_nodes: ['IM-L3-003', 'IM-L3-017', 'IM-L3-018', 'IM-L3-019', 'IM-L3-009'],
        checkpoint_type: 'quiz',
        pass_criteria: '測驗正確率 >= 80%',
      },
      {
        id: 'MS-IM-FELINE-03',
        title: '路徑完成',
        description: '通過貓內科疾病綜合病例挑戰',
        required_nodes: ['IM-L3-017', 'IM-L3-019'],
        checkpoint_type: 'case',
        pass_criteria: '病例挑戰得分 >= 70%',
      },
    ],
  ...
  {
    id: 'PATH-CROSS-JAUNDICE',
    title: '黃疸病患的鑑別診斷路徑',
    description: '以黃疸為主訴，整合內科、臨床病理、外科的跨科鑑別診斷流程。從肝膽生化判讀出發，系統性區分肝前性（溶血）、肝性（肝炎/脂肪肝）、肝後性（膽道阻塞）黃疸，並建立完整治療計畫。適合一般臨床獸醫及住院獸醫。',
    specialty: 'IM',
    target_audience: '一般臨床獸醫、住院獸醫',
    estimated_hours: 10,
    path_nodes: [
      { node_id: 'CPATH-L4-002', is_required: true, phase: '診斷基礎', learning_note: '起點：血清生化判讀——肝臟酵素（ALT/ALP/GGT）與膽紅素分類是黃疸鑑別的第一步' },
      { node_id: 'IM-L2-004', is_required: true, phase: '病理機轉', learning_note: '肝膽病理機轉——理解膽紅素代謝與膽汁淤積機轉' },
      { node_id: 'IM-L3-005', is_required: true, phase: '肝前性黃疸', learning_note: 'IMHA——溶血性貧血導致的肝前性黃疸，需緊急鑑別' },
      { node_id: 'IM-L3-009', is_required: true, phase: '肝性黃疸', learning_note: '貓肝臟脂肪變性——貓最常見的肝性黃疸病因' },
      { node_id: 'IM-L3-019', is_required: true, phase: '肝後性黃疸', learning_note: '貓膽管炎與三合症——肝後性膽道阻塞的典型代表' },
      { node_id: 'IM-L3-025', is_required: true, phase: '肝後性黃疸', learning_note: '膽囊黏液囊腫——犬阻塞性黃疸的重要外科病因' },
      { node_id: 'IM-L3-026', is_required: true, phase: '肝性黃疸', learning_note: '犬慢性肝炎——犬肝性黃疸的主要病因，需肝切片確診' },
      { node_id: 'IM-L4-002', is_required: true, phase: '綜合診斷', learning_note: '尿液分析與腎功能評估——膽紅素尿與尿膽原輔助黃疸分類' },
    ],
    milestones: [
      {
        id: 'MS-CROSS-JAUN-01',
        title: '黃疸三分類掌握',
        description: '能正確區分肝前性、肝性、肝後性黃疸並列舉代表疾病',
        required_nodes: ['CPATH-L4-002', 'IM-L2-004', 'IM-L3-005'],
        checkpoint_type: 'quiz',
        pass_criteria: '測驗正確率 >= 80%',
      },
      {
        id: 'MS-CROSS-JAUN-02',
        title: '肝臟酵素模式判讀',
        description: '掌握肝細胞損傷型 vs 膽汁淤積型酵素變化模式',
        required_nodes: ['IM-L3-009', 'IM-L3-019', 'IM-L3-025', 'IM-L3-026'],
        checkpoint_type: 'quiz',
        pass_criteria: '測驗正確率 >= 80%',
      },
      {
        id: 'MS-CROSS-JAUN-03',
        title: '路徑完成',
        description: '通過黃疸病患綜合鑑別診斷病例挑戰，制定完整治療計畫',
        required_nodes: ['IM-L4-002'],
        checkpoint_type: 'case',
        pass_criteria: '病例挑戰得分 >= 70%',
      },
    ],
