...
export const ECC_CASES: CaseChallenge[] = [
  ...
  // ========== CASE-ECC-012: 犬術後敗血症 ==========
  {
    ...
    species: '犬',
    scenario: {
      signalment: '7 歲已絕育雌性混種犬，體重 22 kg',
      chief_complaint: '子宮蓄膿（pyometra）手術後第 2 天，高燒 40.8°C、心搏過速、低血壓',
      brief_history: '兩天前因開放型子宮蓄膿行卵巢子宮切除術（OHE），手術順利。術後第一天食慾略減但精神尚可。今日（術後第二天）護理師發現犬精神明顯沉鬱、不進食、體溫升至 40.8°C。心率增快至 160 bpm。腹部觸診有疼痛反應。靜脈留置針部位無明顯紅腫。術前血檢顯示 WBC 35,000（左移）、BUN/Cr 正常。',
    },
    steps: [
      {
        step_number: 1,
        step_type: 'physical_examination',
        title: 'SIRS 評估與初級判斷',
        prompt: '進行系統性評估。你需要確認是否符合 SIRS 標準並辨識感染源。請選擇最關鍵的 3 項發現。',
        available_actions: [
          '體溫 40.8°C + 心率 160 bpm + 呼吸速率 44 次/分 → 符合 SIRS 標準（≥ 2/4 criteria）',
          '血壓 SAP 80 mmHg（低血壓），黏膜磚紅色（brick red），CRT < 1 秒（hyperdynamic shock）',
          '腹部觸診中至重度疼痛，腹壁緊繃，手術切口周圍輕度紅腫滲液',
          '四肢末端溫暖（早期分佈性休克）',
          '心肺聽診正常',
          '周邊淋巴結無腫大',
        ],
        ...
        feedback_correct: '正確！犬 SIRS 標準（≥ 2/4）：HR > 120 bpm、RR > 40 次/分、T > 39.7°C 或 < 37.2°C、WBC > 18,000 或 < 5,000。本犬滿足 3/4（HR、RR、T）。磚紅黏膜 + CRT < 1 秒 + 低血壓 = hyperdynamic/distributive shock 的典型表現（早期敗血性休克）。腹部疼痛 + 手術切口紅腫 = 最可能感染源為腹腔（術後腹膜炎或手術部位感染）。',
        feedback_incorrect: '敗血症 = SIRS + 感染。SIRS 標準（犬）：HR > 120、RR > 40、T > 39.7 或 < 37.2、WBC > 18,000 或 < 5,000（≥ 2/4）。Hyperdynamic shock（早期敗血性休克）：磚紅黏膜、CRT < 1 秒、四肢溫暖、低血壓。腹部疼痛提示腹腔為感染源。',
        key_learning_points: [
          '犬 SIRS 標準：HR > 120、RR > 40、T > 39.7 或 < 37.2、WBC > 18,000 或 < 5,000',
          'SIRS + suspected/confirmed infection = Sepsis',
          '早期敗血性休克（hyperdynamic）：磚紅黏膜、CRT < 1 秒、四肢溫暖',
          '晚期敗血性休克（hypodynamic）：黏膜蒼白灰暗、CRT > 3 秒、四肢冰冷',
        ],
      },
      {
        step_number: 2,
      ...
      },
      {
        ...
        step_type: 'result_interpretation',
        title: '檢查結果判讀',
        prompt: '檢查結果如下：\n• CBC：WBC 42,000（band 18%，toxic changes），Hct 32%，Plt 85,000\n• 生化：Glucose 55 mg/dL（低），BUN 42，Cr 2.0，ALT 120，Albumin 1.8 g/dL，Lactate 5.8 mmol/L\n• AFAST：腹腔有少量游離液體\n• 血培養：已採集送檢\n\n你如何判讀？',
        available_actions: [
      ...
      },
      {
        ...
        available_actions: [
          ...
          '繼續給予更多晶體液至 120 mL/kg',
          'Dopamine 高劑量 15-20 μg/kg/min',
          '停止輸液改用白蛋白',
          'Vasopressin 單獨使用',
        ],
        correct_actions: [
    ...
    expert_pathway: {
      reasoning: '術後第二天高燒 + SIRS criteria + 低血壓 → 敗血症。AFAST 腹腔液 + 穿刺分析 = 敗血性腹膜炎。多器官功能障礙早期（低血糖、AKI、血小板↓、乳酸↑）。治療：液體復甦 + 廣效 IV 抗生素 + source control（手術再探查）。Fluid-refractory → Norepinephrine 升壓。',
      key_decisions: [
        '早期辨識 SIRS criteria + 感染源 = 敗血症',
        '腹腔穿刺確認敗血性腹膜炎',
        'Source control 是敗血性腹膜炎的決定性治療',
        '液體復甦無反應時啟動 Norepinephrine',
        '監測多器官功能（血糖、乳酸、腎功能、凝血）',
      ],
      common_pitfalls: [
        '將術後發燒歸因於「正常手術反應」而延誤診斷',
        '僅給予抗生素不進行 source control',
        '液體復甦不足或過量',
        '使用 Dopamine 而非 Norepinephrine',
        '忽略低血糖的監測與處理',
      ],
    },
    related_nodes_for_review: ['ECC-L3-011', 'ECC-L2-001', 'ECC-L4-001', 'ECC-L5-001', 'ECC-L2-002'],
    tags: ['敗血症', 'SIRS', 'sepsis', '腹膜炎', 'source control', 'Norepinephrine', 'case_challenge'],
  },
  ...
  // ========== CASE-ECC-013: 幼犬低血糖急診 ==========
  {
    ...
    species: '犬',
    scenario: {
      signalment: '8 週齡未絕育雌性約克夏梗犬（Yorkshire Terrier），體重 0.4 kg',
      chief_complaint: '在家突然癲癇發作、失去意識，約 3 分鐘',
      brief_history: '飼主今日帶回新購幼犬。到家後約 4 小時開始不太活潑，拒絕進食。約 1 小時前突然四肢僵直、全身抽搐約 3 分鐘後停止但意識不清。飼主緊急送醫。幼犬過去健康狀況不詳，尚未施打疫苗。',
    },
    steps: [
      {
        step_number: 1,
        step_type: 'physical_examination',
        title: '急診初級評估（ABCDE）',
        prompt: '面對意識不清的幼犬，進行 ABCDE 評估。請選擇最關鍵的 3 項發現。',
        available_actions: [
          'D：精神極度沉鬱（pain-responsive），瞳孔對光反射遲鈍',
          'E：體溫 35.8°C（低體溫），血糖快速測定 28 mg/dL（嚴重低血糖，正常 74-143）',
          'A/B：呼吸道通暢，呼吸速率 18 次/分（偏低）',
          'C：心率 180 bpm（幼犬可接受範圍），黏膜略蒼白，CRT 2 秒',
          'PCV/TP 快速測定：PCV 35%（正常），TP 4.5 g/dL（正常偏低）',
          '體重 0.4 kg（低於品種標準）',
        ],
        correct_actions: [
          'D：精神極度沉鬱（pain-responsive），瞳孔對光反射遲鈍',
        ...
        key_learning_points: [
          ...
          '玩具犬種幼犬（Yorkshire、Chihuahua、Pomeranian）為低血糖高風險群',
          '低血糖的神經徵兆依序：虛弱 → 肌肉震顫 → 癲癇 → 昏迷',
        ],
      },
      {
        step_number: 2,
        step_type: 'treatment_plan',
        title: '緊急 Dextrose 治療',
        prompt: '血糖 28 mg/dL 的意識不清幼犬。你的緊急治療？選擇最適當的 2 項。',
        available_actions: [
      ...
      },
      {
        ...
        key_learning_points: [
          ...
          'PSS 篩檢：空腹 + 餐後膽汁酸、血氨、腹部超音波',
          '幼犬低血糖的常見原因：餵食不足 > PSS > 敗血症 > 寄生蟲',
          'Insulinoma 和 Addison 不常見於幼犬',
        ],
      },
      {
        step_number: 4,
        ...
        key_learning_points: [
          ...
          '幼犬低血糖預防：少量多餐（q3-4h）、高能量飼料',
          '幼犬驅蟲：pyrantel 2 週齡開始，每 2 週至 12 週齡',
        ],
      },
      {
        step_number: 5,
        ...
        key_learning_points: [
          ...
          '玩具犬種幼犬為低血糖高風險群',
          'PSS 是 Yorkshire 幼犬反覆低血糖的重要鑑別',
          '飼主衛教（少量多餐）是預防復發的關鍵',
        ],
      },
    ],
    expert_pathway: {
      reasoning: '8 週齡 Yorkshire 幼犬抽搐 + 意識不清 → 先測血糖 = 28 mg/dL（嚴重低血糖）→ IV Dextrose 0.5 g/kg 急救 + CRI + 復溫 → 意識恢復 → BUN 偏低 + 低 Albumin → PSS 需排除 → 膽汁酸篩檢 + 飼主衛教少量多餐。',
      key_decisions: [
        '抽搐幼犬第一步測血糖而非直接給予抗癲癇藥',
        '50% Dextrose 需稀釋至 12.5% 才能安全 IV',
        'Bolus 後立即 CRI 防止反彈性低血糖',
        'BUN 偏低 + Yorkshire → 排除 PSS',
        '少量多餐是預防幼犬低血糖的關鍵',
      ],
      common_pitfalls: [
        '將抽搐歸因於癲癇而未測血糖',
        '口服餵食意識不清的幼犬（誤嚥風險）',
        '50% Dextrose 未稀釋直接 IV（靜脈炎）',
        '低血糖矯正後不查根本原因',
        '忽略低體溫的同步處理',
      ],
    },
    related_nodes_for_review: ['ECC-L3-015', 'ECC-L1-002', 'ECC-L4-001', 'ECC-L5-001'],
    tags: ['低血糖', '幼犬', 'Dextrose', 'Yorkshire', 'PSS', '癲癇', 'case_challenge'],
  },
  ...
  // ========== CASE-ECC-014: 犬艾迪森危象 ==========
  {
    ...
    species: '犬',
    scenario: {
      signalment: '4 歲已絕育雌性 Wheaten Terrier，體重 16 kg',
      chief_complaint: '突然在家倒地不起、全身無力，心跳似乎很慢',
      brief_history: '飼主報告犬過去 2-3 個月間歇性食慾不振和嘔吐，曾帶至外院診斷為「腸胃炎」給予對症治療，症狀反覆。今日突然在散步回來後倒地無法站立。到院時犬極度虛弱、無法自行行走。過去一年體重逐漸下降約 2 kg。',
    },
    steps: [
      {
        step_number: 1,
      ...
      },
      {
        ...
        key_learning_points: [
          ...
          '高血鉀 ECG 變化：T 波尖高 → P 波消失 → QRS 增寬 → sine wave',
          'ACTH 刺激試驗是 Addison 確診金標準',
          '可先抽基礎 cortisol 再開始治療（dexamethasone 不干擾 cortisol 測定）',
        ],
      },
      {
        step_number: 3,
      ...
      },
      {
        ...
        step_type: 'treatment_plan',
        title: '穩定後確診與長期管理',
        prompt: '經 4 小時輸液與藥物治療後：HR 回升至 100 bpm，MAP 85 mmHg，K+ 降至 5.5，Na+ 升至 134。精神明顯改善。ACTH 刺激試驗結果（在 Dexamethasone 後採集）：Pre-ACTH cortisol 0.3 μg/dL，Post-ACTH cortisol 0.5 μg/dL（< 2 μg/dL = 確診 Addison）。你的長期管理計畫？選擇最適當的 2 項。',
        available_actions: [
        ...
        key_learning_points: [
          ...
          'DOCP 2.2 mg/kg IM q25d 是犬 Addison mineralocorticoid 首選',
          '低劑量 Prednisolone 0.1-0.2 mg/kg 補充 glucocorticoid',
          '壓力事件需 stress dose（Prednisolone 加倍 2-3 天）',
          '治療得當的 Addison 犬壽命與正常犬相同',
        ],
      },
    ],
    expert_pathway: {
      reasoning: '中年 Wheaten Terrier + 間歇性 GI 症狀 + 體重下降 + 急性虛脫 + 心搏過緩（不合理組合）→ 電解質 Na:K 16.4 → Addisonian crisis。急性治療：0.9% NaCl + Dexamethasone + Calcium gluconate → 穩定後 ACTH stim 確診 → 長期 DOCP + Prednisolone + 飼主衛教。',
      key_decisions: [
        '心搏過緩 + 休克的不合理組合 → 懷疑高血鉀/Addison',
        'Na:K 比值快速篩檢',
        '選擇 Dexamethasone 不影響後續 ACTH 試驗',
        'K+ > 7 + ECG 變化 → Calcium gluconate 心臟保護',
    ...
    related_nodes_for_review: ['ECC-L3-016', 'ECC-L1-001', 'ECC-L1-002', 'ECC-L5-001'],
    tags: ['Addison', '艾迪森', '高血鉀', '低鈉', 'DOCP', '腎上腺', 'Great Pretender', 'case_challenge'],
  },
];
