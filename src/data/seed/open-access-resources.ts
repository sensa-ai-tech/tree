...
export const OPEN_ACCESS_RESOURCES: OpenAccessResource[] = [
  ...
  {
    id: 'OAR-NEURO-005',
    title: 'New Insights Into the Treatment of Meningoencephalomyelitis of Unknown Origin Since 2009: A Review of 671 Cases (2023)',
    title_zh: 'MUO 治療新見解：2009 年後 671 例系統性回顧（2023）',
    url: 'https://doi.org/10.3389/fvets.2023.1114798',
    source: 'Other',
    specialty: ['NEURO'],
    topics: ['MUO', 'GME', 'NME', 'immunosuppression', 'cytarabine', 'canine'],
    access_type: 'open_access',
    description_zh: 'Front Vet Sci 2023 開放取用系統性回顧（671 例）：彙整 2009 年後 MUO 各免疫抑制方案（類固醇±cytarabine/ciclosporin/MMF）的療效與存活證據。Jeffery & Granger，doi:10.3389/fvets.2023.1114798。',
  },
  {
    id: 'OAR-NEURO-006',
  ...
  {
    id: 'OAR-NEURO-010',
    title: 'Perspectives on Pharmacologic Strategies in the Management of Meningoencephalomyelitis of Unknown Origin in Dogs (2023)',
    title_zh: '犬 MUO 藥物治療策略觀點（2023）',
    url: 'https://doi.org/10.3389/fvets.2023.1167002',
    source: 'Other',
    specialty: ['NEURO', 'IM'],
    topics: ['MUO', 'GME', 'NME', 'meningoencephalitis', 'immunosuppression', 'corticosteroids', 'canine'],
    access_type: 'open_access',
    description_zh: 'Front Vet Sci 2023 開放取用文獻回顧：比較犬 MUO 各藥物治療策略，普遍支持類固醇+cytarabine 或 類固醇+ciclosporin。Beasley et al.，doi:10.3389/fvets.2023.1167002。',
  },
  {
    id: 'OAR-NEURO-011',
