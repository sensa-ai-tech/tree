...
請選擇最正確的整合判讀。`,
      ...
      },
      {
        ...
        step_type: 'case_summary',
        title: '追蹤結果判讀與長期品質管理',
        prompt: `Methimazole 治療 4 週後追蹤結果：
- T4 3.2 ug/dL（正常化）、BUN 55 mg/dL（↑）、Cr 3.4 mg/dL（↑↑）
- SDMA 28 ug/dL（↑↑）、USG 1.015、UPC 0.5、血壓 165 mmHg

請選擇最正確的整合判讀與後續計畫。`,
        available_actions: [
          '甲亢已控制但揭露 IRIS CKD Stage 3（Cr 3.4），需調降 Methimazole 劑量維持 T4 在正常高限以保護腎灌流，同時啟動 CKD 管理（腎臟處方飲食、磷結合劑、血壓控制）、每 2-4 週追蹤腎指數與 T4',
          'Methimazole 效果良好（T4 正常化），腎指數升高為暫時性反應，維持目前劑量觀察即可',
          '停止 Methimazole 治療，因腎功能惡化代表藥物副作用',
        ],
        correct_actions: [
          '甲亢已控制但揭露 IRIS CKD Stage 3（Cr 3.4），需調降 Methimazole 劑量維持 T4 在正常高限以保護腎灌流，同時啟動 CKD 管理（腎臟處方飲食、磷結合劑、血壓控制）、每 2-4 週追蹤腎指數與 T4',
        ],
        ...
        key_learning_points: [
          ...
          'IRIS CKD 分期需在甲亢控制後重新評估才準確',
          '「容許輕度甲亢」策略：調降 Methimazole 劑量維持 T4 正常高限以保護殘存腎灌流',
          '臨床病理追蹤監測的核心價值：動態數據（T4 + 腎指數 + UPC + 血壓）驅動治療決策',
          '長期管理需定期追蹤（每 2-4 週至穩定後每 3 個月），以數據指導方案調整',
        ],
      },
    ],
    expert_pathway: {
