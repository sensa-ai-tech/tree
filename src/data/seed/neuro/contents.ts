...
| MCT 飲食/補充劑的療效 | 油補充劑有 RCT 支持；市售處方飼料加 ZNS 的小型試驗統計不顯著（n=7），勿過度宣稱 | Level II |`,
  ...
  references: [
    { type: 'guideline', citation: 'Berendt M et al. International veterinary epilepsy task force consensus report on epilepsy definition, classification and terminology in companion animals. BMC Vet Res. 2015;11:182. doi:10.1186/s12917-015-0461-2', relevance: 'IVETF 癲癇定義與分類共識' },
    { type: 'guideline', citation: 'De Risio L et al. International veterinary epilepsy task force consensus proposal: diagnostic approach to epilepsy in dogs. BMC Vet Res. 2015;11:148. doi:10.1186/s12917-015-0462-1', relevance: 'IVETF 分層診斷流程' },
    { type: 'journal', citation: 'Podell M et al. 2015 ACVIM Small Animal Consensus Statement on Seizure Management in Dogs. J Vet Intern Med. 2016;30(2):477-490. doi:10.1111/jvim.13841', relevance: 'ACVIM 癲癇管理共識' },
...
> 臨床內容與所有劑量需獸醫師依現行指引與仿單核對。`,
  ...
  references: [
    { type: 'journal', citation: 'Brisson BA. Intervertebral disc disease in dogs. Vet Clin North Am Small Anim Pract. 2010;40(5):829-858. doi:10.1016/j.cvsm.2010.06.001', relevance: '犬 IVDD 綜合回顧' },
    ...
    { type: 'journal', citation: 'Olby N et al. Long-term functional outcome of dogs with severe injuries of the thoracolumbar spinal cord. J Am Vet Med Assoc. 2003;222(6):762-769. doi:10.2460/javma.2003.222.762', relevance: '重度 IVDD 長期預後數據' },
...
| 血漿置換（plasmapheresis）在犬可不可行 | 人 GBS 有效，但獸醫端的技術跟設備還沒普及 | Level IV |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Cuddon PA. Acquired canine peripheral neuropathies. Vet Clin North Am Small Anim Pract. 2002;32(1):207-249. doi:10.1016/s0195-5616(03)00086-x', relevance: '犬後天性周邊神經病變綜合回顧' },
...
| 犬認知功能障礙（CCD）的診斷標準 | 缺乏金標準，依賴行為問卷，主觀性高 | Level IV |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Muñana KR. Update on the approach to seizures in dogs and cats. Vet Clin North Am Small Anim Pract. 2013;43(5):xi-xii. doi:10.1016/j.cvsm.2013.04.008', relevance: '犬貓癲癇管理更新' },
    { type: 'guideline', citation: 'Berendt M et al. International veterinary epilepsy task force consensus report on epilepsy definition, classification and terminology in companion animals. BMC Vet Res. 2015;11:182. doi:10.1186/s12917-015-0461-2', relevance: 'IVETF 癲癇定義與分類共識，神經科核心指引' },
...
| 犬離子通道突變與癲癇表型的關聯 | 已知 KCNJ10、LGI2 等突變，但多數品種癲癇的遺傳基礎不明 | Level III |`,
  ...
  references: [
    ...
    { type: 'guideline', citation: 'Podell M et al. 2015 ACVIM Small Animal Consensus Statement on Seizure Management in Dogs. J Vet Intern Med. 2016;30(2):477-490. doi:10.1111/jvim.13841', relevance: 'ACVIM 共識，神經生理機轉基礎與 AED 作用靶點' },
...
| Acetazolamide 對犬水腦症的長期療效 | 短期可減少 CSF 產生，但長期 compensatory 機制可能抵消效果 | Level III |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Di Terlizzi R, Platt SR. The function, composition and analysis of cerebrospinal fluid in companion animals: Part I. Vet J. 2006;172(3):422-431. doi:10.1016/j.tvjl.2005.07.021', relevance: 'CSF 生理與組成綜述' },
    { type: 'journal', citation: 'Jessen NA et al. The glymphatic system: A beginner\'s guide. Neurochem Res. 2015;40(12):2583-2599. doi:10.1007/s11064-015-1581-6', relevance: 'Glymphatic system 基礎回顧' },
...
| 肉毒桿菌中毒犬的抗毒素治療效益 | 犬用抗毒素可及性低，且治療窗口狹窄（毒素結合後不可逆），臨床效益爭議 | Level IV |`,
  ...
  references: [
    { type: 'journal', citation: 'Shelton GD. Myasthenia gravis and disorders of neuromuscular transmission. Vet Clin North Am Small Anim Pract. 2002;32(1):189-206. doi:10.1016/s0195-5616(03)00085-8', relevance: '犬 MG 綜合回顧' },
...
| PMM 的精確擴散機轉 | CSF 毒性介質擴散 vs 血管微血栓仍為假說，缺乏動物模型驗證 | Level IV |`,
  ...
  references: [
    { type: 'journal', citation: 'Castel A et al. Clinical characteristics of dogs with progressive myelomalacia following acute intervertebral disc extrusion. J Vet Intern Med. 2017;31(6):1782-1789. doi:10.1111/jvim.14829', relevance: 'PMM 臨床特徵與預後' },
    ...
    { type: 'journal', citation: 'Olby NJ et al. Long-term functional outcome of dogs with severe injuries of the thoracolumbar spinal cord. J Am Vet Med Assoc. 2003;222(6):762-769. doi:10.2460/javma.2003.222.762', relevance: '深痛覺喪失犬長期預後數據' },
    { type: 'guideline', citation: 'Olby NJ, Moore SA, Brisson B, et al. ACVIM consensus statement on diagnosis and management of acute canine thoracolumbar intervertebral disc extrusion. J Vet Intern Med. 2022;36(5):1570-1596. doi:10.1111/jvim.16480', relevance: '急性脊髓損傷（以胸腰椎 IVDE 為主）管理之現行 ACVIM 共識。更正原「Moore 2020 JVIM 34(5)」幻影引用（Crossref 查無該 2020 共識，真實者為 Olby 2022）' },
  ],
  is_current: true,
  created_at: now,
};
...
| CSF 正常但臨床高度懷疑 MUO 的處理 | 局灶性 GME 的 CSF 可能正常，是否直接開始免疫抑制治療存在爭議 | Level III |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Di Terlizzi R, Platt SR. The function, composition and analysis of cerebrospinal fluid in companion animals. Vet J. 2009;180(1):15-32. doi:10.1016/j.tvjl.2007.11.024', relevance: 'CSF 分析綜合回顧' },
    ...
    { type: 'guideline', citation: 'De Risio L et al. International veterinary epilepsy task force consensus proposal: diagnostic approach to epilepsy in dogs. BMC Vet Res. 2015;11:148. doi:10.1186/s12917-015-0462-1', relevance: 'IVETF 共識，CSF 分析在癲癇診斷中的角色' },
  ],
  is_current: true,
  created_at: now,
};
...
| 預防性開窗術（Prophylactic fenestration）的價值 | 術中對鄰近椎間隙同時開窗以降低復發率，是否增加手術時間與風險而效益有限 | Level III |`,
  ...
  references: [
    ...
    { type: 'guideline', citation: 'Olby NJ, Moore SA, Brisson B, et al. ACVIM consensus statement on diagnosis and management of acute canine thoracolumbar intervertebral disc extrusion. J Vet Intern Med. 2022;36(5):1570-1596. doi:10.1111/jvim.16480', relevance: 'IVDD 手術適應症/時機之現行 ACVIM 共識。更正原「Moore 2020」幻影引用（真實者為 Olby 2022，Crossref 驗證）' },
    { type: 'journal', citation: 'Brisson BA. Intervertebral disc disease in dogs. Vet Clin North Am Small Anim Pract. 2010;40(5):829-858. doi:10.1016/j.cvsm.2010.06.001', relevance: '脊椎手術預後數據' },
    { type: 'journal', citation: 'Jeffery ND et al. Factors associated with recovery from paraplegia in dogs with loss of pain perception in the pelvic limbs following intervertebral disk herniation. J Am Vet Med Assoc. 2016;248(4):386-394. doi:10.2460/javma.248.4.386', relevance: 'Grade V IVDD 術後恢復因子分析' },
  ],
  is_current: true,
  created_at: now,
};
...
| 幹細胞治療合併復健的附加效益 | 犬 IVDD 術後幹細胞移植的療效尚無高品質 RCT 支持，是否合併復健可提升效果不明 | Level IV |`,
  ...
  drug_api_links: [],
  references: [
    { type: 'journal', citation: 'Kathmann I et al. Daily controlled physiotherapy increases survival time in dogs with suspected degenerative myelopathy. J Vet Intern Med. 2006;20(4):927-932. doi:10.1111/j.1939-1676.2006.tb01807.x', relevance: 'DM 犬復健延長存活時間的關鍵研究' },
    ...
    { type: 'journal', citation: 'Drum MG. Physical rehabilitation of the canine neurologic patient. Vet Clin North Am Small Anim Pract. 2010;40(1):181-193. doi:10.1016/j.cvsm.2009.09.009', relevance: '神經科復健綜述' },
    { type: 'guideline', citation: 'Olby NJ, Moore SA, Brisson B, et al. ACVIM consensus statement on diagnosis and management of acute canine thoracolumbar intervertebral disc extrusion. J Vet Intern Med. 2022;36(5):1570-1596. doi:10.1111/jvim.16480', relevance: '現行 ACVIM IVDE 共識（診斷/手術時機/預後）。更正原「Moore 2020」幻影引用；若需術後復健專屬實證，建議 DVM 另補真實復健文獻' },
  ],
  is_current: true,
  created_at: now,
};
...
| 硬膜外膿瘍手術引流 vs 保守治療 | 大多數可單獨抗生素治療，手術引流的適應症尚未標準化 | Level IV |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Tipold A, Stein VM. Inflammatory diseases of the spine in small animals. Vet Clin North Am Small Anim Pract. 2010;40(5):871-879. doi:10.1016/j.cvsm.2010.05.008', relevance: '犬脊椎炎症性疾病綜合回顧' },
    ...
    { type: 'guideline', citation: 'Sykes JE, Hartmann K, Lunn KF, et al. ACVIM Consensus Statement: 2010 ACVIM Small Animal Consensus Statement on Leptospirosis，Diagnosis, Epidemiology, Treatment, and Prevention. J Vet Intern Med. 2011;25(1):1-13. doi:10.1111/j.1939-1676.2010.0654.x', relevance: 'ACVIM 鉤端螺旋體共識聲明（discospondylitis 重要鑑別感染源）' },
  ],
  is_current: true,
  created_at: now,
};
...
| GSD 預防性繁殖篩檢 | 目前無可靠的影像或基因篩檢方法可在症狀前預測 DLSS | Level IV |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Meij BP, Bergknut N. Degenerative lumbosacral stenosis in dogs. Vet Clin North Am Small Anim Pract. 2010;40(5):983-1009. doi:10.1016/j.cvsm.2010.05.006', relevance: 'DLSS 綜合回顧與治療策略' },
    { type: 'journal', citation: 'Suwankong N et al. "Review and retrospective analysis of degenerative lumbosacral stenosis in 156 dogs treated by dorsal laminectomy." Vet Comp Orthop Traumatol. 2008;21(3):285-293. doi:10.1055/s-0037-1617374', relevance: '腰薦椎手術預後回顧研究（引用真偽稽核：原標題/卷期頁 21(5):382-391 誤植 → 更正真實文 21(3):285-293 + DOI）' },
...
| 長時間 EEG 監測 | 犬癲癇的連續腦波監測（ICU 設定） | 人醫已商業化，獸醫原型系統少數機構有 |`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Cuddon PA. Electrophysiology in neuromuscular disease. Vet Clin North Am Small Anim Pract. 2002;32(1):31-62. doi:10.1016/s0195-5616(03)00079-2', relevance: '獸醫神經肌肉疾病電生理檢查綜述' },
...
- CKCS 品種篩檢（BVA/KC SM Scheme）可降低後代 SM 風險`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Rusbridge C, Knowler SP. Coexistence of occipital dysplasia and occipital hypoplasia/syringomyelia in the cavalier King Charles spaniel. J Small Anim Pract. 2006;47(10):603-606. doi:10.1111/j.1748-5827.2006.00048.x', relevance: 'CKCS CM/SM 病理與盛行率原始研究' },
    { type: 'journal', citation: 'Sanchis-Mora S, et al. Pregabalin for the treatment of syringomyelia-associated neuropathic pain in dogs: a randomised, placebo-controlled, double-blinded clinical trial. Vet J. 2019;250:55-62. doi:10.1016/j.tvjl.2019.06.006', relevance: 'Pregabalin 治療 SM 神經性疼痛的隨機對照試驗' },
  ],
  is_current: true,
  created_at: now,
};
...
- 即使積極治療，多數犬最終仍因疾病進展而安樂死`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Lowrie M, et al. "Effect of a constant rate infusion of cytosine arabinoside on mortality in dogs with meningoencephalitis of unknown origin." Vet J. 2016;213:1-5. doi:10.1016/j.tvjl.2016.03.026', relevance: 'Cytarabine 治療 MUO 的臨床療效研究（引用真偽稽核：原「JSAP 2016;57(5):263-270, add-on therapy」查無 → 更正為真實 Lowrie 2016 Vet J CRI cytarabine 研究 + DOI）' },
...
- 與主人溝通管理期望不能省：目標是「維持生活品質」而非「治癒」`,
  ...
  references: [
    ...
    { type: 'journal', citation: 'Landsberg GM, Nichol J, Araujo JA. Cognitive dysfunction syndrome: a disease of canine and feline brain aging. Vet Clin North Am Small Anim Pract. 2012;42(4):749-768. doi:10.1016/j.cvsm.2012.04.003', relevance: 'CDS 綜合回顧，病理、診斷、治療' },
    { type: 'journal', citation: 'Dewey CW, et al. Canine cognitive dysfunction: pathophysiology, diagnosis, and treatment. Vet Clin North Am Small Anim Pract. 2019;49(3):477-499. doi:10.1016/j.cvsm.2019.01.013', relevance: 'CDS 最新病理與治療進展' },
