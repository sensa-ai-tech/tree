...
- **✅ iter25 再解 2 條**：**Bentley**（SURG-L2-001）「140 cases/17(3):46」誤植 → 真實同作者文 **Bentley AM 2007「Comparison of dogs with septic peritonitis: 1988-1993 vs 1999-2003」JVECC 17(4):391-398 `10.1111/j.1476-4431.2007.00251.x`**；**Boston**（ONCO-L5-004）「8 dogs 2-3 fraction」捏造 → 真實 **Pagano C 2016「appendicular osteosarcoma 10 Gy×2」VRU 57(5):551-556 `10.1111/vru.12389`**（body 皆無依賴捏造數字）。
- **閘門不可再降末態**：全 seed SUSPECT_AUTHOR_MISMATCH = **2**（僅剩 Shaw-Rush＝Compendium、Klein-Peterson＝Can Vet J 2010，皆真實但未被 Crossref 索引）＋ SUSPECT_NOT_FOUND = 1（Gwaltney-Brant Vet Med pre-DOI）。此 3 條為 Crossref 覆蓋盲區之真實文，**非捏造、無法再以自動化消除**，屬已知可容忍雜訊。**全 seed 已無任何未解釋之疑捏造引用。**
